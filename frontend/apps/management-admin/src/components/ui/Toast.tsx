...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
    >
      <div className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg ${styles.bg} shadow-lg ring-1 ring-black ring-opacity-5 border-l-4 ${styles.border}`}>
        <div className="p-4">
