...
type TabType = 'marketplace' | 'installed' | 'analytics' | 'settings';
...
export function PluginManagement({ className = '' }: PluginManagementProps) {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'analytics':
        return (
          <PluginAnalytics className="mt-6" />
        );

      case 'settings':
        return (
          <PluginSystemSettings className="mt-6" />
        );
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Only allow signed plugins from verified publishers</p>
            </div>
            <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Permit installation of unsigned plugins (not recommended)</p>
            </div>
            <input
              type="checkbox"
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleSettingChange('max_memory_per_plugin', parseInt(e.target.value))}
        ...
        <div className="px-6 py-4 border-t border-gray-200">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Send anonymous usage data to improve the platform</p>
            </div>
            <input
              type="checkbox"
