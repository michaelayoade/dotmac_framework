  ...
  const [notificationSettings, setNotificationSettings] = useState<NotificationSettingsType>(() => {
    ...
    return {
      ...
      preferences: defaults.preferences.map(pref => ({
        ...
        email: ['billing', 'service', 'account', 'technical', 'support', 'system'].includes(pref.category) ? true : pref.email,
        sms: ['service', 'account', 'technical', 'system'].includes(pref.category) ? true : pref.sms,
        push: ['service', 'account', 'technical', 'support', 'system'].includes(pref.category) ? true : pref.push,
      })),
      globalSettings: {
        enableAll: true,
        quietHours: {
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-semibold text-gray-900">Master Administration Settings</h1>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-purple-700">
                These settings control enterprise-wide administrative access and monitoring capabilities.
                All configuration changes are subject to the highest security protocols and are audited for compliance.
                Changes to security settings may require additional authentication and approval processes.
              </p>
            </div>
          </div>
        </div>
