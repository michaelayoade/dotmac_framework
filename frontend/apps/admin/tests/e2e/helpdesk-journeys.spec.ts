...
(ENABLED ? test : test.skip)('chat start/end via /api/support @journey @admin @api', async ({ request }) => {
...
(ENABLED ? test : test.skip)('knowledge base vote via /api/support @journey @admin @api', async ({ request }) => {
