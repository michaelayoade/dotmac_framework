...
describe('useBillingStore', () => {
    ...
    it('selects all invoices', () => {
      ...
      act(() => {
        useBillingStore.setState({
          invoices: [
            { id: 'inv-001', customerName: 'Test 1', customerEmail: 'test1@example.com', total: 100, status: 'pending', dueDate: '2025-01-15', lastReminderSent: null },
            { id: 'inv-002', customerName: 'Test 2', customerEmail: 'test2@example.com', total: 200, status: 'pending', dueDate: '2025-01-16', lastReminderSent: null },
          ],
        });
      });
  ...
  describe('Business Actions', () => {
    it('sends invoice reminder successfully', async () => {
      ...
      act(() => {
        useBillingStore.setState({
          invoices: [
            { id: 'inv-001', customerName: 'Test', customerEmail: 'test@example.com', total: 100, status: 'pending', dueDate: '2025-01-15', lastReminderSent: null },
          ],
        });
      });
  ...
  describe('Computed Values', () => {
    beforeEach(() => {
      ...
      act(() => {
        useBillingStore.setState({
          invoices: [
            { id: 'inv-001', customerName: 'John Doe', customerEmail: 'john@example.com', total: 100, status: 'paid', dueDate: '2025-01-15', lastReminderSent: null },
            { id: 'inv-002', customerName: 'Jane Smith', customerEmail: 'jane@example.com', total: 200, status: 'pending', dueDate: '2025-01-16', lastReminderSent: null },
            { id: 'inv-003', customerName: 'Bob Johnson', customerEmail: 'bob@example.com', total: 150, status: 'overdue', dueDate: '2024-12-01', lastReminderSent: null },
          ],
          searchQuery: '',
        });
      });
  ...
  describe('Selectors', () => {
    beforeEach(() => {
      act(() => {
        useBillingStore.setState({
          invoices: [
            { id: 'inv-001', customerName: 'Test', customerEmail: 'test@example.com', total: 100, status: 'paid', dueDate: '2025-01-15', lastReminderSent: null },
          ],
  ...
  describe('Error Handling', () => {
    ...
    it('handles API errors gracefully', async () => {
      const { billingApi } = require('../../lib/api-client');
      billingApi.fetchInvoices.mockResolvedValue({ success: false, error: 'API Error', code: 'API_ERROR' });
