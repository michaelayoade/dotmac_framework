...
import { validateAndSanitizeInput, presetValidators, type ValidationResult, type ValidationOptions } from '../../lib/input-validation';
...
interface SecureInputProps extends BaseSecureInputProps, Omit<React.InputHTMLAttributes<HTMLInputElement>, 'onChange' | 'onBlur'> {
  value: string;
  onChange: (value: string, isValid: boolean) => void;
  onBlur?: (value: string, isValid: boolean) => void;
}

interface SecureTextareaProps extends BaseSecureInputProps, Omit<React.TextareaHTMLAttributes<HTMLTextAreaElement>, 'onChange' | 'onBlur'> {
  value: string;
  onChange: (value: string, isValid: boolean) => void;
  onBlur?: (value: string, isValid: boolean) => void;
}
