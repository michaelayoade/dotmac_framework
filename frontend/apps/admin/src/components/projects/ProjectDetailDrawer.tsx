...
export const ProjectDetailDrawer: React.FC<ProjectDetailProps> = ({
  project,
  isOpen,
  onClose
}) => {
  ...
  const daysUntilDue = Math.ceil((new Date(project.due_date).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24));
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <div className={`font-medium ${daysUntilDue < 0 ? 'text-red-600' : daysUntilDue < 30 ? 'text-yellow-600' : 'text-green-600'}`}>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-lg font-bold">{project.budget_used_percentage.toFixed(1)}%</span>
                  </div>
                  
                  <div className="w-full bg-gray-200 rounded-full h-3 mb-4">
                    <div
                      className={`h-3 rounded-full transition-all ${
                        project.budget_used_percentage > 90 ? 'bg-red-500' : 
                        project.budget_used_percentage > 75 ? 'bg-yellow-500' : 'bg-green-500'
                      }`}
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    <div className="text-center">
                      <div className="text-lg font-bold text-gray-900">{formatCurrency(project.budget_allocated)}</div>
                      <div className="text-gray-600">Allocated</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-bold text-blue-600">{formatCurrency(budgetUsed)}</div>
                      <div className="text-gray-600">Used</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-bold text-green-600">{formatCurrency(budgetRemaining)}</div>
