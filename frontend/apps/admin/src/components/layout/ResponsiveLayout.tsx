...
export function Container({ 
  ...
  return (
    <div className={cn(layoutUtils.container[size], className)}>
      {children}
    </div>
  );
}
...
export function Grid({ 
  ...
  return (
    <div className={cn('grid', baseClass, gapClass, responsiveClasses, className)}>
      {children}
    </div>
  );
}
...
export function GridItem({ 
  ...
  return (
    <div className={cn(baseClass, responsiveClasses, className)}>
      {children}
    </div>
  );
}
...
export function ShowOnTablet({ children, className = '' }: { children: ReactNode; className?: string }) {
  return (
...
export function ResponsiveText({
  ...
  return (
    <div className={cn(sizeClasses, weightClass, className)}>
      {children}
    </div>
  );
}
  ...
  return (
    <div className={cn('min-h-screen bg-gray-50', className)}>
      ...
      <div className="flex">
        ...
        <main className={cn(
          'flex-1',
          sidebar && !isMobile && sidebarWidths[sidebarWidth] && `ml-${sidebarWidths[sidebarWidth].split('-')[1]}`,
