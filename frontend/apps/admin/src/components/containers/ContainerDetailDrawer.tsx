...
export const ContainerDetailDrawer: React.FC<ContainerDetailProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'logs' | 'environment' | 'network'>('overview');
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-medium">{container.cpu_usage.toFixed(1)}%</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="text-right text-sm">
                          <div className="font-medium">
                            ↓ {formatBytes(container.network_io.rx)} / ↑ {formatBytes(container.network_io.tx)}
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    {Object.entries(container.environment).map(([key, value]) => (
                      <div key={key} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="text-sm text-gray-600 font-mono max-w-xs truncate">{value}</div>
                      </div>
                    ))}
                  </div>
                ) : (
                      ...
                      {container.ports.map((port, index) => (
                        <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-sm text-gray-600">Host port ({port.protocol.toUpperCase()})</div>
                          </div>
                        </div>
                      ))}
                    </div>
