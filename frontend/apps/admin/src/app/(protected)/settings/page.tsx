  ...
  const [notificationSettings, setNotificationSettings] = useState<NotificationSettingsType>(() => {
    ...
    return {
      ...
      preferences: defaults.preferences.map(pref => ({
        ...
        email: ['billing', 'service', 'account', 'technical', 'support'].includes(pref.category) ? true : pref.email,
        sms: ['service', 'account', 'technical'].includes(pref.category) ? true : pref.sms,
        push: ['service', 'account', 'technical', 'support'].includes(pref.category) ? true : pref.push,
      })),
      globalSettings: {
        enableAll: true,
        quietHours: {
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-blue-700">
                These settings apply to your administrator account. Changes to security settings may require re-authentication.
                All administrative actions are logged for security auditing purposes.
              </p>
            </div>
          </div>
        </div>
