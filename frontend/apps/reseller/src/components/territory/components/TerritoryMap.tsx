...
export function TerritoryMap({
			...
			case "competition":
				return territory.competition === "low"
					...
					: territory.competition === "medium"
						...
						: "#EF4444";
			case "opportunities": {
				const totalOpportunities = Object.values(
					territory.opportunities,
				).reduce((a, b) => a + b, 0);
				return totalOpportunities > 15
					? "#10B981"
	...
	if (!isClient) {
		return (
			<div
				className={`bg-gray-100 rounded-lg flex items-center justify-center h-96 ${className}`}
			>
