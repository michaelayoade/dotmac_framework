...
const navItems: NavItem[] = [
	...
	},
	{
		...
		href: "/sales-tools",
		icon: Calculator,
		description: "Quote generator & pricing tools",
	},
	{
		...
		icon: PieChart,
		description: "Advanced commission analytics",
	},
	{
		id: "territory",
		...
		href: "/territory",
		icon: MapPin,
		description: "Geographic territory analysis",
	},
	{
		id: "commissions",
		label: "Commissions",
	...
	},
	{
		...
		href: "/goals",
		icon: Target,
		description: "Track sales targets",
		badge: "2",
	},
	{
		id: "resources",
		...
		href: "/resources",
		icon: FileText,
		description: "Sales materials and tools",
	},
	{
		id: "partner",
...
export function ResellerNavigationEnhanced() {
