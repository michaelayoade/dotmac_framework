													...
													return (
														<>
															...
															<div className="flex justify-between text-gray-600">
																...
																<span>
																	${totals.installationTotal.toFixed(2)}
																</span>
															</div>
															<div className="flex justify-between text-gray-600">
										...
										<div>
											...
											<div className="space-y-2 text-sm">
												<p>
													...
													{generatedQuote.contractTerm} months
												</p>
												<p>
													...
													{generatedQuote.services.map((service: any) => (
														<tr key={service.id}>
															...
															<td className="border border-gray-300 px-4 py-2 text-right">
																$
																{(
																	service.installation * service.quantity
																).toFixed(2)}
															</td>
														</tr>
													))}
									...
									<div className="bg-gray-50 p-6 rounded-lg">
										<div className="space-y-2">
											<div className="flex justify-between">
												...
												<span>
													${generatedQuote.totals.subtotal.toFixed(2)}
												</span>
											</div>
											{generatedQuote.totals.discount > 0 && (
												<div className="flex justify-between text-green-600">
													<span>
														Discount ({generatedQuote.totals.discount}%):
													</span>
													<span>
														-${generatedQuote.totals.discountAmount.toFixed(2)}
													</span>
												</div>
											)}
											<div className="flex justify-between font-semibold text-lg border-t pt-2">
												<span>Monthly Total:</span>
												<span>
													${generatedQuote.totals.monthlyTotal.toFixed(2)}
												</span>
											</div>
											<div className="flex justify-between">
												<span>One-time Installation:</span>
												<span>
													${generatedQuote.totals.installationTotal.toFixed(2)}
												</span>
											</div>
											<div className="flex justify-between font-bold text-xl border-t pt-2">
												<span>Total Contract Value:</span>
												<span>
													${generatedQuote.totals.totalContractValue.toFixed(2)}
												</span>
											</div>
										</div>
									</div>
