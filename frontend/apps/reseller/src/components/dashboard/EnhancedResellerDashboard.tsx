    ...
    <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border hover:shadow-md transition-all group-hover:border-green-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{dashboardStats.marketingResources}</p>
                <p className="text-sm text-green-600 mt-1">
                  12 new this month
                </p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div key={activity.id} className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className={clsx('w-2 h-2 rounded-full', getPriorityColor(activity.priority))}>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/collaboration" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
              Manage Tasks
            </Link>
          </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/sales" className="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center space-x-1">
