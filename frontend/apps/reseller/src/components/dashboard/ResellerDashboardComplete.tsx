				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="mt-1 text-gray-600">
							Welcome back, {mockResellerData.profile.name}
						</p>
					</div>
					<div className="flex items-center space-x-3">
						<Badge
							variant={getTierColor(mockResellerData.profile.tier)}
							size="lg"
						>
					...
					<Card>
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="mt-1 font-bold text-2xl text-gray-900">
									{formatCurrency(
										mockResellerData.metrics.monthlyRecurringRevenue,
									)}
								</p>
								<p className="mt-1 text-green-600 text-sm">
						...
						<div className="space-y-6">
							<div>
								...
								<p className="mt-1 text-gray-500 text-xs">
									{mockResellerData.targets.monthly.remaining} more needed to
									reach target
								</p>
							</div>
							...
							<div>
								...
								<p className="mt-1 text-gray-500 text-xs">
									{formatCurrency(mockResellerData.targets.revenue.remaining)}{" "}
									remaining
								</p>
							</div>
						</div>
						...
						<div className="space-y-4">
							...
							<div className="grid grid-cols-1 gap-4">
								<div className="flex items-center space-x-2">
									...
									<span className="text-gray-900 text-sm">
										{mockResellerData.profile.email}
									</span>
								</div>
								<div className="flex items-center space-x-2">
									<Phone className="h-4 w-4 text-gray-400" />
									<span className="text-gray-900 text-sm">
										{mockResellerData.profile.phone}
									</span>
								</div>
								<div className="flex items-center space-x-2">
								...
								<div className="flex items-center space-x-2">
									...
									<span className="text-gray-900 text-sm">
										Partner since{" "}
										{formatDate(mockResellerData.profile.joinDate)}
									</span>
								</div>
							</div>
						</div>
