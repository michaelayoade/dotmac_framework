...
interface MarketingResource {
  ...
  title: string;
  description: string;
  type: 'brochure' | 'flyer' | 'presentation' | 'video' | 'email-template' | 'social-media' | 'case-study' | 'whitepaper';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        {[
          ...
          <button
            key={category.key}
            onClick={() => setSelectedCategory(category.key === selectedCategory ? 'all' : category.key)}
            className={clsx(
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center space-x-4 ml-4">
                          <div className="text-right">
                            <div className="text-sm font-medium text-gray-900">{resource.downloads} downloads</div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-4">Promoting fiber services to enterprise clients</p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-4">Targeting local small businesses for basic packages</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
