...
test.describe('Partners Management', () => {
  ...
  test('should approve pending partner', async ({ page }) => {
    ...
    const pendingPartner = page.locator('[data-testid="partner-row"]:has([data-testid="partner-status"]:has-text("PENDING"))').first();
  ...
  test('should suspend partner', async ({ page }) => {
    ...
    const activePartner = page.locator('[data-testid="partner-row"]:has([data-testid="partner-status"]:has-text("ACTIVE"))').first();
