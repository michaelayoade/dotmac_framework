...
const managementRoleMapping = {
  ...
  permissionMap: {
    'MASTER_ADMIN': [
      'VIEW_DASHBOARD', 'VIEW_PROFILE', 'MANAGE_RESELLERS',
      'APPROVE_COMMISSIONS', 'VIEW_ANALYTICS', 'MANAGE_TERRITORIES',
      'PROCESS_PAYOUTS', 'MANAGE_TRAINING', 'SYSTEM_ADMIN',
      'USER_MANAGEMENT', 'PLATFORM_SETTINGS'
    ],
    'CHANNEL_MANAGER': [
      'VIEW_DASHBOARD', 'VIEW_PROFILE', 'MANAGE_RESELLERS',
      'APPROVE_COMMISSIONS', 'VIEW_ANALYTICS', 'MANAGE_TERRITORIES',
      'PROCESS_PAYOUTS', 'MANAGE_TRAINING'
    ],
    'OPERATIONS_MANAGER': [
      'VIEW_DASHBOARD', 'VIEW_PROFILE', 'VIEW_ANALYTICS',
      'MANAGE_TERRITORIES', 'VIEW_COMMISSIONS'
    ]
  },
