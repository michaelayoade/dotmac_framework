...
export const ticketsConfig: ManagementPageConfig = {
  ...
  metrics: [
    ...
    { key: 'avgResponse', title: 'Avg Response (h)', value: 0, format: 'number', precision: 1, color: '#2563eb' },
    { key: 'resolved', title: 'Resolved (30d)', value: 0, format: 'number', precision: 0, color: '#10b981' },
  ],
  filters: [
  ...
  actions: [
    { key: 'new-ticket', label: 'New Ticket', variant: 'primary' },
  ],
};
