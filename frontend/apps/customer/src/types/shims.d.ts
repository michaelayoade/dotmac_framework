declare module '@dotmac/providers' {
  ...
  export interface ErrorBoundaryProps { portal: 'customer'|'admin'|'reseller'|'technician'|'management'; fallback?: any; onError?: (error: Error, info: any) => void; children?: React.ReactNode }
