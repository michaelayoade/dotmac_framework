...
export const ServiceOverviewSectionOptimized = memo<ServiceOverviewProps>(function ServiceOverviewSection({
  networkStatus,
  dataUsage,
  onRefreshStatus,
  onViewDetails,
  ...
  return (
    ...
    prevProps.networkStatus.currentSpeed.download === nextProps.networkStatus.currentSpeed.download &&
