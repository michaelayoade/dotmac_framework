...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Design tokens define the visual foundation of the DotMac platform including colors, typography, spacing, and more.'
      }
    }
  }
};
...
const TypographyScale = () => {
  const typeScale = [
    ...
    { name: 'Headline Large', class: 'text-3xl font-semibold', sample: 'The quick brown fox jumps' },
    { name: 'Headline Medium', class: 'text-2xl font-semibold', sample: 'The quick brown fox jumps over' },
    { name: 'Headline Small', class: 'text-xl font-semibold', sample: 'The quick brown fox jumps over the lazy dog' },
    { name: 'Title Large', class: 'text-lg font-medium', sample: 'The quick brown fox jumps over the lazy dog' },
    { name: 'Title Medium', class: 'text-base font-medium', sample: 'The quick brown fox jumps over the lazy dog' },
    { name: 'Body Large', class: 'text-base', sample: 'The quick brown fox jumps over the lazy dog and continues running through the forest.' },
    { name: 'Body Medium', class: 'text-sm', sample: 'The quick brown fox jumps over the lazy dog and continues running through the forest with great speed.' },
    { name: 'Body Small', class: 'text-xs', sample: 'The quick brown fox jumps over the lazy dog and continues running through the forest with great speed and agility.' }
  ];
