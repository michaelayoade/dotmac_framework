...
test.describe('Visual Workflow Designer - Complete User Journeys', () => {
  ...
  test('should create complete ISP customer onboarding workflow', async ({ page }) => {
    ...
    await page.fill(
      ...
      'Complete customer onboarding with service activation'
    );
    ...
    await page.fill(
      ...
      'Collect customer details and service preferences'
    );
    ...
    await page.fill(
      ...
      'Basic 100Mbps,Premium 500Mbps,Business 1Gbps'
    );
    ...
    await expect(page.locator('[data-testid="workflow-item"]')).toContainText(
  ...
  test('should export and import workflow definitions', async ({ page }) => {
    ...
    await page.fill(
      '[data-testid="workflow-description"]',
      'Test workflow for export functionality'
    );
          ...
          steps: [
            {
              ...
              title: 'Imported Step',
              type: 'form',
              fields: [{ key: 'test_field', label: 'Test Field', type: 'text', required: true }],
            },
          ],
        })
      ),
    ...
    await expect(page.locator('[data-testid="workflow-name"]')).toHaveValue(
  ...
  test('should integrate with existing WorkflowTemplate system', async ({ page }) => {
    ...
    await page.fill(
      '[data-testid="field-options"]',
      'Service Upgrade,Technical Support,Billing Inquiry'
    );
    await page.check('[data-testid="field-required"]');
    ...
    await page.fill(
      ...
      'Customer wants to upgrade to 1Gbps service'
    );
    ...
    await expect(page.locator('[data-testid="completion-message"]')).toContainText(
