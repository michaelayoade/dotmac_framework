...
test.describe('Workflow Failure and Recovery Scenarios', () => {
  ...
  test('workflow step failure with automatic retry', async () => {
    ...
    await expect(adminPage.locator('[data-testid="retry-attempt-1"]')).toBeVisible({ timeout: 10000 });
    await expect(adminPage.locator('[data-testid="retry-attempt-2"]')).toBeVisible({ timeout: 15000 });
    await expect(adminPage.locator('[data-testid="step-completed"]')).toBeVisible({ timeout: 25000 });
  ...
  test('workflow failure with manual intervention', async () => {
    ...
    await expect(adminPage.locator('[data-testid="intervention-alert"]')).toContainText('finance_manager');
    await expect(adminPage.locator('[data-testid="failure-reason"]')).toContainText('Payment gateway connection timeout');
    ...
    await adminPage.fill('[data-testid="intervention-notes"]', 'Using backup payment processor due to primary gateway timeout');
    ...
    await expect(adminPage.locator('[data-testid="workflow-completed"]')).toBeVisible({ timeout: 15000 });
    
    // Check intervention log
    await adminPage.click('[data-testid="view-intervention-log"]');
    await expect(adminPage.locator('[data-testid="intervention-log"]')).toContainText('backup payment processor');
  ...
  test('network connectivity failure recovery', async () => {
    ...
    await expect(customerPage.locator('[data-testid="submission-failed"]')).toBeVisible({ timeout: 10000 });
    await expect(customerPage.locator('[data-testid="retry-notification"]')).toContainText('connection failed');
    
    // Verify automatic retry
    await expect(customerPage.locator('[data-testid="auto-retry-indicator"]')).toBeVisible();
    await expect(customerPage.locator('[data-testid="ticket-created-success"]')).toBeVisible({ timeout: 15000 });
  ...
  test('database transaction rollback on workflow failure', async () => {
    ...
    await expect(adminPage.locator('[data-testid="processing-row-3"]')).toBeVisible({ timeout: 10000 });
    ...
    await expect(adminPage.locator('[data-testid="import-failed"]')).toContainText('All changes rolled back');
    ...
    await expect(adminPage.locator('[data-testid="import-completed"]')).toBeVisible({ timeout: 15000 });
  ...
  test('workflow timeout and recovery', async () => {
    ...
    await expect(adminPage.locator('[data-testid="step-executing"]')).toBeVisible();
    await expect(adminPage.locator('[data-testid="timeout-warning"]')).toBeVisible({ timeout: 12000 });
    await expect(adminPage.locator('[data-testid="timeout-occurred"]')).toBeVisible({ timeout: 15000 });
    await expect(adminPage.locator('[data-testid="extending-timeout"]')).toBeVisible();
    await expect(adminPage.locator('[data-testid="step-completed"]')).toBeVisible({ timeout: 35000 });
  ...
  test('workflow state recovery after system restart', async () => {
    ...
    await expect(adminPage.locator('[data-testid="step-1-completed"]')).toBeVisible({ timeout: 10000 });
    ...
    await expect(adminPage.locator('[data-testid="step-2-completed"]')).toBeVisible({ timeout: 20000 });
  ...
  test('cascading failure handling', async () => {
    ...
    await expect(adminPage.locator('[data-testid="workflow-0-completed"]')).toBeVisible({ timeout: 10000 });
    await expect(adminPage.locator('[data-testid="workflow-1-failed"]')).toBeVisible({ timeout: 10000 });
    await expect(adminPage.locator('[data-testid="workflow-2-cancelled"]')).toBeVisible({ timeout: 5000 });
    
    // Verify cascade handling
    await expect(adminPage.locator('[data-testid="cascade-failure-detected"]')).toBeVisible();
    await expect(adminPage.locator('[data-testid="dependent-workflows-cancelled"]')).toContainText('1 workflow cancelled');
    ...
    await expect(adminPage.locator('[data-testid="workflow-1-completed"]')).toBeVisible({ timeout: 15000 });
    await expect(adminPage.locator('[data-testid="workflow-2-completed"]')).toBeVisible({ timeout: 15000 });
