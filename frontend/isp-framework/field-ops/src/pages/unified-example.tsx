...
import { formatCurrency, formatNumber, formatDuration, debounce, generateId } from '@dotmac/utils';
import { useAsync, useDebounce, useLocalStorage } from '@dotmac/hooks';
import {
  Wrench,
  Clock,
  CheckCircle,
...
export default function UnifiedExamplePage() {
  // Using unified hooks
  const { data, loading, error, refetch } = useAsync(fetchTechnicianData, {
    immediate: true,
      ...
      <div className='max-w-7xl mx-auto space-y-6'>
        ...
        <div className='flex items-center justify-between'>
          <div>
            ...
            <p className='text-gray-600 mt-1'>Comprehensive DRY Package Integration Example</p>
          </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6'>
            <h3 className='text-lg font-semibold text-gray-900 mb-4'>Create Work Order</h3>
