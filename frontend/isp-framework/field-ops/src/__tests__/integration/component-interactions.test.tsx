...
const MockWorkOrdersList = React.lazy(() =>
  Promise.resolve({
        ...
        <div data-testid='work-orders-list'>
          ...
          {mockWorkOrders.map((wo) => (
            <div key={wo.id} data-testid={`work-order-${wo.id}`}>
              ...
              <button onClick={() => onWorkOrderSelect(wo.id)} data-testid={`select-${wo.id}`}>
                View Details
              </button>
            </div>
          ))}
...
const MockWorkOrderDetails = React.lazy(() =>
  Promise.resolve({
      ...
      return (
        <div data-testid='work-order-details'>
          ...
          <section>
            ...
            <div>
              <button onClick={() => handleStatusChange('in_progress')} data-testid='start-work'>
                Start Work
              </button>
              <button onClick={() => handleStatusChange('completed')} data-testid='complete-work'>
                Complete Work
              </button>
            </div>
          </section>
          ...
          <section>
            ...
            <div data-testid='work-order-checklist'>
              <label>
                <input type='checkbox' data-testid='checklist-item-1' />
                Install equipment
              </label>
              <label>
                <input type='checkbox' data-testid='checklist-item-2' />
                Test connection
              </label>
            </div>
          </section>
...
const MockOfflineIndicator = React.lazy(() =>
  Promise.resolve({
    default: function OfflineIndicator() {
      ...
      return (
        <div data-testid='offline-indicator'>
          <span data-testid='connection-status'>{isOnline ? 'Online' : 'Offline'}</span>
          {!isOnline && (
