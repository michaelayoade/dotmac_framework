...
import { PenTool, Trash2, Check, X, RotateCcw, Download, Smartphone } from 'lucide-react';
        ...
        <div className='bg-white border-b border-gray-200 p-4 flex-shrink-0'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              {customerName && (
                <p className='text-sm text-primary-600 mt-1'>Customer: {customerName}</p>
              )}
            </div>
            ...
            {isEmpty && (
              ...
              >
                <div className='text-center text-gray-400'>
                  ...
                  {!isLandscape && (
                    <p className='text-xs mt-1'>Rotate device for better experience</p>
                  )}
                </div>
              </motion.div>
            )}
      ...
      <AnimatePresence>
        {showPreview && signatureData && (
          ...
          >
            ...
            >
              <h3 className='text-lg font-semibold mb-4 text-center'>Confirm Signature</h3>
              ...
              <div className='text-sm text-gray-600 mb-4 space-y-1'>
                {customerName && (
                  <p>
                    <strong>Signee:</strong> {customerName}
                  </p>
                )}
                {workOrderId && (
                  <p>
