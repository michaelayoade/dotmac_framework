      ...
      <div className='mobile-card'>
        ...
        <div className='flex items-start space-x-4'>
          ...
          <div className='flex-1'>
            <h1 className='text-lg font-bold text-gray-900 mb-1'>{customer.name}</h1>
            <p className='text-gray-600 text-sm mb-2'>Service ID: {customer.serviceId}</p>
            ...
            <div className='mobile-card'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <div className='text-sm font-medium text-gray-900'>{customer.planName}</div>
                  <div className='text-xs text-gray-600 mt-1'>{customer.planSpeed}</div>
                </div>
                ...
                <div>
                  ...
                  <div className='text-sm font-medium text-gray-900'>
                    {customer.lastServiceDate ? formatDate(customer.lastServiceDate).date : 'None'}
                  </div>
                </div>
              </div>
            </div>
                          ...
                          <div className='space-y-2'>
                            ...
                            {service.notes && (
                              <div>
                                ...
                                <div className='text-sm text-gray-900 mt-1'>{service.notes}</div>
                              </div>
                            )}
                            ...
                            {service.workOrderId && (
                              <div>
                                ...
                                <div className='text-sm text-gray-900'>#{service.workOrderId}</div>
                              </div>
                            )}
                          </div>
                        </motion.div>
