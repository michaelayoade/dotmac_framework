            ...
            >
              ...
              <div className='p-4 space-y-4'>
                ...
                <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                  ...
                  <div className='text-right'>
                    <p className='text-lg font-semibold text-blue-600'>{sync.pendingOperations}</p>
                  </div>
                </div>
                ...
                <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                  ...
                  <div className='text-right'>
                    <p className='text-lg font-semibold text-yellow-600'>{sync.conflicts}</p>
                    {sync.conflicts > 0 && (
                      <button
                        onClick={handleViewConflicts}
                ...
                {sync.error && (
                  ...
                  >
                    <div className='flex items-start space-x-3'>
                      ...
                      <button onClick={sync.clearError} className='text-red-500 hover:text-red-700'>
                        <X className='w-4 h-4' />
                      </button>
                    </div>
                  </motion.div>
              ...
              <div className='p-4 border-t border-gray-200'>
                <div className='flex space-x-3'>
                  ...
                  >
                    ...
                    <span>{sync.isConnected ? 'Force Sync' : 'Reconnect'}</span>
                  </button>
