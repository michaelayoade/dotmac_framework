...
import { AlertCircle, DollarSign, Eye, EyeOff, TrendingUp, Users } from 'lucide-react';
...
export function ResellerLogin() {
  ...
  const { values, errors, isSubmitting, setValue, handleSubmit } = useFormValidation(loginFields);
  ...
  const { values, handleChange, handleSubmit, getFieldError, hasFieldError } = form;
                ...
                <div className='mt-6 space-y-2 text-center'>
                  ...
                  <div className='border-gray-200 border-t pt-4'>
                    <p className='text-gray-500 text-xs'>
                      ...
                      >
                        {process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'partners@example.com'}
                      </a>{' '}
                      |{' '}
                      <a
                        ...
                        className='text-green-600 hover:text-green-500'
                      >
                        {process.env.NEXT_PUBLIC_SUPPORT_PHONE || '1-555-PARTNER'}
                      </a>
                    </p>
                  </div>
                </div>
