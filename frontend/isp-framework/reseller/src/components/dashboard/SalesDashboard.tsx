...
export function SalesDashboard() {
  ...
  const { data: analytics } = useCachedData('sales-analytics', async () => mockSalesAnalytics, {
    ttl: 5 * 60 * 1000,
  });
    ...
    <div className='space-y-6'>
      ...
      >
        ...
        <Card className='p-6 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200'>
          <div className='flex items-center justify-between'>
            <div>
              <p className='text-blue-700 text-sm font-medium'>Conversion Rate</p>
              <p className='text-3xl font-bold text-blue-800'>
                {formatPercent(analytics.performance.conversionRate)}
              </p>
              <div className='flex items-center mt-2'>
                <Target className='h-4 w-4 text-blue-600' />
                <span className='text-blue-600 text-sm ml-1'>Above Average</span>
              </div>
            </div>
        ...
        <Card className='p-6 bg-gradient-to-br from-purple-50 to-indigo-50 border-purple-200'>
          <div className='flex items-center justify-between'>
            <div>
              <p className='text-purple-700 text-sm font-medium'>Avg Deal Size</p>
          ...
          <Card className='p-6'>
            <div className='flex items-center justify-between mb-6'>
              ...
              <div className='text-sm text-gray-600'>
                Total Value:{' '}
                {formatCurrency(
                  analytics.pipeline.reduce((sum: number, stage: any) => sum + stage.value, 0)
                )}
              </div>
            </div>
          ...
          <Card className='p-6'>
            <div className='flex items-center justify-between mb-6'>
              ...
              <div className='flex items-center text-sm text-green-600'>
                ...
                {formatPercent(analytics.performance.revenueGrowth)} vs last month
              </div>
            </div>
            <div className='h-64'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        >
          <Card className='p-6'>
            <div className='flex items-center justify-between mb-6'>
              <h3 className='text-lg font-semibold text-gray-900'>Service Mix</h3>
        ...
        >
          <Card className='p-6'>
            ...
            <div className='space-y-6'>
              {Object.entries(analytics.goals).map(([period, goal]: [string, any]) => (
                <div key={period} className='relative'>
                  <div className='flex items-center justify-between mb-2'>
                    ...
                    <div className='text-right'>
                      ...
                      <div className='text-xs text-gray-600'>{formatPercent(goal.progress)}</div>
                    </div>
                  </div>
                  <div className='w-full bg-gray-200 rounded-full h-3 overflow-hidden'>
                    <motion.div
            ...
            <div className='mt-6 pt-6 border-t border-gray-200'>
              <h4 className='text-sm font-medium text-gray-900 mb-3'>Forecasting</h4>
              <div className='grid grid-cols-2 gap-4'>
                ...
                <div className='text-center p-3 bg-gray-50 rounded-lg'>
                  ...
                  <div className='text-sm font-semibold text-gray-900'>
                    {formatCurrency(analytics.forecasting.nextQuarter.predicted)}
                  </div>
            ...
            <ResponsiveContainer width='100%' height='100%'>
              <BarChart data={analytics.monthlyTrends}>
                ...
                <Tooltip
                  formatter={(value, name) => [
                    name === 'revenue' ? formatCurrency(value as number) : value,
                    name === 'revenue' ? 'Revenue' : name === 'customers' ? 'Customers' : 'Deals',
                  ]}
                />
