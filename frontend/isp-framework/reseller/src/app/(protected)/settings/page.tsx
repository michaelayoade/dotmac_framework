  ...
  const [notificationSettings, setNotificationSettings] = useState<NotificationSettingsType>(() => {
    ...
    return {
      ...
      preferences: defaults.preferences.map((pref) => ({
        ...
        email: ['billing', 'service', 'account', 'commission'].includes(pref.category)
          ? true
          : pref.email,
          ...
          <div className='flex items-start'>
            ...
            <div className='ml-3'>
              ...
              <p className='mt-1 text-sm text-green-700'>
                Your reseller account settings affect customer management capabilities and
                commission tracking. Enable business notifications to stay informed about sales
                opportunities and customer service requests.
              </p>
            </div>
          </div>
        </div>
