  ...
  return (
    <Card className='p-4 space-y-3' data-testid='speed-test-widget'>
      <div className='flex items-center justify-between'>
        ...
        {!running && (
          <Button onClick={start} data-testid='speed-test-start'>
            Start Test
          </Button>
        )}
      </div>
      ...
      {result && (
        <div className='grid grid-cols-2 gap-3' data-testid='speed-test-result'>
          <Card className='p-3'>
            ...
            <div className='text-2xl font-bold'>{result.downMbps} Mbps</div>
          </Card>
          <Card className='p-3'>
            <div className='text-xs text-muted-foreground'>Upload</div>
            <div className='text-2xl font-bold'>{result.upMbps} Mbps</div>
          </Card>
          <Card className='p-3'>
            <div className='text-xs text-muted-foreground'>Latency</div>
            <div className='text-xl font-semibold'>{result.latencyMs} ms</div>
          </Card>
          <Card className='p-3'>
            <div className='text-xs text-muted-foreground'>Jitter</div>
            <div className='text-xl font-semibold'>{result.jitterMs} ms</div>
          </Card>
        </div>
      )}
    </Card>
