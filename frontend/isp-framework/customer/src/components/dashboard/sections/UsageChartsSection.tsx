        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
          ...
          <div className='bg-gray-50 rounded-lg p-4'>
            ...
            <Progress
              ...
              size='md'
              variant={
                getUsageColor(usagePercentage) === 'red'
                  ? 'error'
                  : getUsageColor(usagePercentage) === 'yellow'
                    ? 'warning'
                    : 'default'
              }
              showValue={false}
            ...
            <div className='flex justify-between items-center mt-2'>
              <span className='text-xs text-gray-500'>{currentUsage.limit} GB limit</span>
          ...
          <div className='bg-blue-50 rounded-lg p-4'>
            ...
            <Progress
              ...
              showValue={false}
            />
            <p className='text-xs text-blue-600 mt-2'>{downloadPercentage.toFixed(1)}% of limit</p>
          </div>
          ...
          <div className='bg-green-50 rounded-lg p-4'>
            ...
            <Progress
              ...
              showValue={false}
            />
            <p className='text-xs text-green-600 mt-2'>{uploadPercentage.toFixed(1)}% of limit</p>
          </div>
        </div>
