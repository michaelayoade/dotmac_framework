...
export const CustomerFilesManagement: React.FC = () => {
  ...
  const handleViewFile = (file: CustomerFile) => {
    // Track access
    setFiles((prev) =>
      prev.map((f) => (f.id === file.id ? { ...f, lastAccessed: new Date().toISOString() } : f))
    );
  ...
  return (
    ...
    >
      <div className='bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-auto'>
        <div className='p-6'>
          <h2 id='upload-title' className='text-xl font-semibold mb-6'>
            Upload Files
          </h2>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            >
              ...
              <div>
                ...
                <p className='text-sm text-gray-500 mt-1'>PDF, Images, Documents up to 10MB each</p>
              </div>
            </div>
