        ...
        schema: {
          ...
          properties: {
            ...
            weatherContingency: {
              ...
              enumNames: [
                'Proceed Regardless',
                'Reschedule if Bad Weather',
                'Indoor Work Only if Weather is Bad',
              ],
            },
          },
      ...
      <div className={`provisioning-welcome ${className || ''}`}>
        ...
        >
          <div className='welcome-header text-center mb-8'>
            ...
            <h1 className='text-3xl font-bold text-gray-900 mb-2'>Service Provisioning Workflow</h1>
          ...
          <div className='action-buttons flex gap-4 justify-center'>
            <Button onClick={handleStart} size='lg' className='min-w-40'>
              Start Provisioning
            </Button>

            {onCancel && (
              <Button onClick={handleCancel} variant='outline' size='lg' className='min-w-32'>
                Cancel
              </Button>
            )}
          </div>
