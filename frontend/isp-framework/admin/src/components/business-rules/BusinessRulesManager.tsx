...
export function BusinessRulesManager() {
  ...
  const [activeView, setActiveView] = useState<'rules' | 'templates' | 'testing' | 'analytics'>(
    'rules'
  );
    ...
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <div className='flex gap-2'>
          <Button variant='outline' onClick={handleTestRules} className='flex items-center gap-2'>
      ...
      {isCreating && (
        <Card className='p-6'>
          <RuleBuilder onSave={handleSaveRule} onCancel={() => setIsCreating(false)} />
        </Card>
      )}
      ...
      <div className='grid grid-cols-1 gap-4'>
            ...
            <div className='flex items-start justify-between'>
              <div className='flex-1'>
                ...
                <div className='flex items-center gap-4 text-sm text-gray-500'>
                  ...
                  {rule.portalScope.length > 0 && <span>Scope: {rule.portalScope.join(', ')}</span>}
                </div>
              </div>
        ...
        {rules.length === 0 && (
          <Card className='p-12 text-center'>
            ...
            <Button onClick={() => setIsCreating(true)}>Create First Rule</Button>
          </Card>
        )}
      </div>
    </div>
