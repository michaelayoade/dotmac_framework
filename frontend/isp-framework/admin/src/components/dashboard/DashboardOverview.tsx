      ...
      <Card className='p-6'>
        ...
        <div className='grid grid-cols-2 gap-4 md:grid-cols-4'>
          <button
            ...
            onClick={() =>
              audit.logUserAction('add_customer_initiated', {
          ...
          <button
            ...
            className='rounded-lg border p-4 text-center transition-colors hover:bg-gray-50'
            onClick={() =>
              audit.logUserAction('network_config_accessed', {
          ...
          <button
            ...
            className='rounded-lg border p-4 text-center transition-colors hover:bg-gray-50'
            onClick={() =>
              audit.logUserAction('alerts_viewed', {
          ...
          <button
            ...
            className='rounded-lg border p-4 text-center transition-colors hover:bg-gray-50'
            onClick={() =>
              audit.logUserAction('system_backup_initiated', {
                actionCategory: 'system_admin',
