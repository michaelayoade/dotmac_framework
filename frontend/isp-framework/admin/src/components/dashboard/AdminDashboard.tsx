          ...
          churn_alerts: [
            {
              ...
              health_score: 35,
              priority: 'urgent',
              recommended_action: 'Immediate contact - retention offer',
            },
            {
              customer_name: 'Alice Brown',
              health_score: 45,
              priority: 'high',
              recommended_action: 'Proactive outreach - check satisfaction',
            },
          ],
          total_at_risk: 2,
          urgent_count: 1,
                  ...
                  {churnAlerts.churn_alerts.slice(0, 3).map((alert: any, index: number) => (
                    ...
                    >
                      <div className='flex items-center'>
                        <div
                          className={`w-3 h-3 rounded-full mr-3 ${alert.priority === 'urgent' ? 'bg-red-500' : 'bg-orange-500'}`}
                        ></div>
                        <div>
