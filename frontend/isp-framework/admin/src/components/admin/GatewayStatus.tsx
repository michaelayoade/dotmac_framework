...
const GatewayStatus: React.FC = () => {
  ...
  const overallHealthPercentage =
    detailedStatus.totalServices > 0
    ...
    <div className='p-6'>
      ...
      <div className='flex items-center justify-between mb-6'>
        <div>
          ...
          <p className='text-gray-600 mt-1'>Monitor backend services and routing health</p>
        </div>
      ...
      <div className='bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white mb-6'>
        <div className='flex items-center justify-between'>
          <div>
            ...
            <div className='flex items-center'>
              <div
                className={`w-4 h-4 rounded-full mr-3 ${isHealthy ? 'bg-green-400' : 'bg-red-400'}`}
              />
      ...
      {!isHealthy && (
        <div className='bg-red-50 border border-red-200 rounded-lg p-4'>
          ...
          <p className='text-red-700 mt-2'>
            One or more backend services are experiencing issues. API requests may be slower or
            fail. Check individual service status above.
          </p>
        </div>
      )}
