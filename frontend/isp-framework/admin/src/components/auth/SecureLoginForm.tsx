...
export function SecureLoginForm() {
  ...
  const { login, isLoading, error, clearError, user, isAuthenticated } = useSecureAuthStore();
    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-md w-full space-y-8'>
            ...
            <div className='flex'>
              ...
              <div className='ml-3'>
                <p className='text-sm text-blue-700'>
                  This system uses secure authentication with session monitoring and CSRF
                  protection.
                </p>
              </div>
            </div>
        ...
        <div className='mt-6 text-center text-xs text-gray-500'>
          <p>This system is monitored for security. All access is logged.</p>
          <p className='mt-1'>Session timeout: 30 minutes • Failed attempts lockout: 5 minutes</p>
        </div>
      </div>
    </div>
  );
