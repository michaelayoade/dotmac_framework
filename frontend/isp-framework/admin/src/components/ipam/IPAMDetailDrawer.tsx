...
export const IPAMDetailDrawer: React.FC<IPAMDetailProps> = ({ subnet, isOpen, onClose }) => {
              ...
              <div className='grid grid-cols-3 gap-4 text-sm'>
                <div className='text-center'>
                  <div className='text-2xl font-bold text-gray-900'>
                    {subnet.total_ips.toLocaleString()}
                  </div>
                  <div className='text-gray-600'>Total IPs</div>
                </div>
                <div className='text-center'>
                  <div className='text-2xl font-bold text-blue-600'>
                    {subnet.used_ips.toLocaleString()}
                  </div>
                  <div className='text-gray-600'>Used</div>
                </div>
                <div className='text-center'>
                  <div className='text-2xl font-bold text-green-600'>
                    {subnet.available_ips.toLocaleString()}
                  </div>
              ...
              <div className='bg-gray-50 rounded-lg p-4'>
                <div className='grid grid-cols-2 gap-4 text-sm'>
                  ...
                  <div>
                    ...
                    <div className='text-lg font-semibold'>/{subnet.subnet.split('/')[1]}</div>
                  </div>
                  <div>
                    <div className='text-gray-600'>Network Address</div>
                    <div className='text-lg font-semibold'>{subnet.subnet.split('/')[0]}</div>
                  </div>
                </div>
              </div>
            </div>
