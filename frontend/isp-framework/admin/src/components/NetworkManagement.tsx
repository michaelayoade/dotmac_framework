...
import { Network, Map, Activity, Settings, AlertTriangle, Users, Zap } from 'lucide-react';
...
export const NetworkManagement: React.FC<NetworkManagementProps> = ({ tenantId, currentUser }) => {
  // State for view modes
  const [activeView, setActiveView] = useState<'topology' | 'geographic' | 'monitoring'>(
    'topology'
  );
                    ...
                    <div className='flex justify-between items-center'>
                      ...
                      <span
                        className={`text-sm font-medium ${
                          topology_metrics.basic_stats.is_connected
                            ? 'text-green-600'
                            : 'text-red-600'
                        }`}
                      >
