...
export function BillingTabs({ activeTab, onTabChange, tabs, className = '' }: BillingTabsProps) {
  return (
...
export function BillingTabContent({ activeTab, children, className = '' }: BillingTabContentProps) {
