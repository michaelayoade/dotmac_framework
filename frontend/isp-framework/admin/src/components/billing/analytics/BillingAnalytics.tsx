...
import { RevenueChart, ServiceStatusChart } from '@dotmac/providers/charts/InteractiveChart';
import {
  StatusBadge,
  UptimeIndicator,
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
        ...
        <SlideIn direction='left' delay={0.2}>
          <div className='bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6'>
            <h3 className='text-lg font-semibold text-gray-900 mb-4'>Collections Performance</h3>
