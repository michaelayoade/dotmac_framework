  ...
  return (
    <div className='p-6 max-w-6xl mx-auto'>
      ...
      <div className='mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6'>
        <h2 className='text-lg font-semibold text-blue-900 mb-3'>Multi-Currency Setup Guide</h2>
        <div className='space-y-2 text-sm text-blue-800'>
          <p>
            <strong>1. Base Currency:</strong> Set the customer's primary accounting currency (e.g.,
            NGN for Nigerian ISPs)
          </p>
          <p>
            <strong>2. Payment Currencies:</strong> Add currencies customers can pay in (e.g., USD,
            EUR, GBP)
          </p>
          <p>
          ...
          <p>
            <strong>4. Accounting:</strong> All payments are converted to base currency for
            accounting
          </p>
        </div>
      </div>
