          ...
          <div className='lg:col-span-2 space-y-6'>
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                <div>
                  ...
                  {currentPattern && (
                    <p className='text-sm text-gray-600 mt-1'>{currentPattern.description}</p>
                  )}
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Customize the format of generated Portal IDs</CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
            ...
            <Card>
              ...
              <CardContent>
                <div className='flex items-center space-x-4'>
                  <Button variant='outline' onClick={generateTestIds} disabled={isLoading}>
          ...
          <div className='space-y-6'>
              ...
              <CardContent className='space-y-3'>
                ...
                <div>
                  ...
                  <div className='text-sm font-mono bg-gray-100 px-2 py-1 rounded'>
                    {config.prefix}[{config.length - config.prefix.length - config.suffix.length}{' '}
                    chars]{config.suffix}
                  </div>
                </div>
              </CardContent>
            ...
            {config.max_combinations && config.max_combinations < 10000 && (
              <Alert>
                ...
                <AlertDescription>
                  Warning: Current configuration provides only{' '}
                  {config.max_combinations?.toLocaleString()} unique combinations. Consider
                  increasing length or changing pattern.
                </AlertDescription>
              </Alert>
            )}
            ...
            {currentPattern?.recommended === false && (
              <Alert>
                ...
                <AlertDescription>
                  The selected pattern is not recommended for production use. Consider using
                  "Alphanumeric Clean" for better user experience.
                </AlertDescription>
              </Alert>
            )}
          </div>
