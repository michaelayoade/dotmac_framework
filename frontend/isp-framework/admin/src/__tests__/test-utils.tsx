...
function TestProvidersWrapper({
  ...
  if (withQueryClient) {
    wrapper = <QueryClientProvider client={testQueryClient}>{wrapper}</QueryClientProvider>;
  }
  ...
  if (withErrorBoundary) {
    wrapper = (
      <GlobalErrorProvider>
        <BillingErrorBoundary>{wrapper}</BillingErrorBoundary>
      </GlobalErrorProvider>
    );
  }
