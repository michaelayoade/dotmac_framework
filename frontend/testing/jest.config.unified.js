...
function createUnifiedJestConfig(options = {}) {
  ...
  return {
    ...
    transformIgnorePatterns: [
      'node_modules/(?!(msw|@faker-js/faker|@dotmac|@mswjs)/)'
    ],
...
const portalConfigs = {
  customer: () => createUnifiedJestConfig({
  ...
  technician: () => createUnifiedJestConfig({
  ...
  package: (packageName) => createUnifiedJestConfig({
