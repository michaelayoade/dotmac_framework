            ...
            <div className="space-y-3">
              {projects
                ...
                .map((project) => {
                  ...
                  return (
                    <div key={project.id} className="flex items-center justify-between p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
            ...
            {overdueProjects.slice(0, 5).map((project) => (
              <div key={project.id} className="text-sm text-red-700">
                ...
                <span className="text-red-600 ml-2">
                  Due: {project.planned_end_date && new Date(project.planned_end_date).toLocaleDateString()}
                </span>
              </div>
            ))}
