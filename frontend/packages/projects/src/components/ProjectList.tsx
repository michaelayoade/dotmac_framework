...
import type { ProjectListProps, ProjectFilters, ProjectStatus, ProjectType, ProjectPriority } from '../types';
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFilterChange('project_status', Array.from(e.target.selectedOptions, option => option.value))}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFilterChange('project_type', Array.from(e.target.selectedOptions, option => option.value))}
                  className="w-full p-2 border border-gray-300 rounded-md h-32"
                >
