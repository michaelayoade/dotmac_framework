...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Hook for accessing authentication context. Provides login, logout, and user state management.'
      }
    }
  }
};
            ...
            <div className="flex space-x-2">
              ...
              <button
                onClick={() => {
                  ...
                  alert(`Permission "${permissionToCheck}": ${hasPermission ? 'Granted' : 'Denied'}`);
                }}
...
export const InteractiveDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive demonstration of the useAuth hook with login/logout functionality and permission checking.'
      }
    }
  }
};
