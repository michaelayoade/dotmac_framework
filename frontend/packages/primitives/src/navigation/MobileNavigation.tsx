...
export function MobileNavigation({
  ...
  if (variant === 'tabs') {
    return (
      <nav role="navigation" className={clsx('mobile-nav-tabs', className)} aria-label='Main navigation'>
...
export function EnhancedTabNavigation({
  ...
  return (
    <nav role="navigation" className={clsx('enhanced-tab-nav', className)} aria-label='Main navigation'>
