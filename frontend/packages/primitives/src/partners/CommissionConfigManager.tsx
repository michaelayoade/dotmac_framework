      ...
      render: (config: CommissionConfig) => (
        <div className="flex items-center space-x-2">
          ...
          <span className="capitalize">
            {config.commission_structure.replace('_', ' ')}
          </span>
        </div>
      )
    },
    ...
    },
    {
      ...
      render: (config: CommissionConfig) => (
        <div className="text-sm">
          {config.reseller_type && (
            <div>Type: {config.reseller_type.replace('_', ' ')}</div>
          )}
          {config.reseller_tier && (
            <div>Tier: {config.reseller_tier}</div>
          )}
          {config.territory && (
            <div>Territory: {config.territory}</div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => setFormData({ ...formData, reseller_type: e.target.value || undefined })}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setFormData({ ...formData, reseller_tier: e.target.value || undefined })}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, territory: e.target.value || undefined })}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, minimum_payout: parseFloat(e.target.value) })}
                  className="pl-8"
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, effective_until: e.target.value || undefined })}
              />
            </div>
          </div>
