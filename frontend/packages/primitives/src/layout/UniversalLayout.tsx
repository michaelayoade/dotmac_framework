...
export function UniversalLayout({
              ...
              {(!sidebarCollapsed || isMobile) && (
                <div>
                  <h1 className="font-semibold text-lg">
                    {branding?.companyName || `${variant.charAt(0).toUpperCase() + variant.slice(1)} Portal`}
                  </h1>
                  {tenant && (
  ...
  if (layoutType === 'simple') {
    return (
      <div className={`universal-layout universal-layout--${variant} ${styles.layout} ${className}`}>
        {renderContent()}
      </div>
    );
  }
  ...
  if (layoutType === 'dashboard') {
    return (
      <div className={`universal-layout universal-layout--${variant} h-screen flex flex-col ${styles.layout} ${className}`}>
        {showHeader && (
          <UniversalHeader
            variant={variant}
            user={user}
  ...
  return (
    <div className={`universal-layout universal-layout--${variant} h-screen flex ${styles.layout} ${className}`}>
      {renderSidebar()}
