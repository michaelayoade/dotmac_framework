...
export const defaultPortalRoles: PortalRoleConfig = {
  ...
  reseller: {
    admin: [
      ...
      'commissions:read', 'network:read'
    ],
    manager: [
      'customers:read', 'customers:create', 'customers:update',
      'billing:read', 'reports:read', 'commissions:read'
    ],
  ...
  management: {
    ...
    manager: [
      'tenants:*', 'users:*', 'system:read', 'system:config',
...
export function hasPermission(
  ...
  return effectivePermissions.some(p =>
    matchesPermissionPattern(permission, p)
  );
}
...
export function hasAnyPermission(
  ...
  return permissions.some(permission =>
    hasPermission(user, permission, portal)
  );
}
