...
export function UniversalLoginForm({
  ...
  const handlePortalIdChange = useCallback((value: string) => {
  ...
  return (
    <div className={`auth-form-container ${className}`}>
      ...
      >
        {/* Header */}
        <div className="px-8 pt-8 pb-6 text-center" style={{ backgroundColor: 'var(--auth-muted)' }}>
          {branding.logo && (
            <img
              src={branding.logo}
                    ...
                    <div key={field.name} className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          type={field.name === 'password' && !showPassword ? 'password' : field.config.type}
