...
export class SentryErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    const { portalType, beforeCapture, onError, enableReporting = true, level = 'error', tags } = this.props;
  ...
  private showUserFeedbackDialog = (eventId: string) => {
    Sentry.showReportDialog({
      ...
      subtitle: 'Our team has been notified. You can help us improve by providing additional details.',
