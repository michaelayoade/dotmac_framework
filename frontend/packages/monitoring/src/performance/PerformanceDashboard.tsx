          ...
          <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
            <div className="flex items-center">
              <div className={`w-3 h-3 rounded-full mr-2 ${
                asset.type === 'javascript' ? 'bg-yellow-500' :
                asset.type === 'stylesheet' ? 'bg-blue-500' :
                asset.type === 'font' ? 'bg-purple-500' : 'bg-gray-500'
              }`} />
...
export const PerformanceDashboard: React.FC = () => {
  ...
  const getVitalStatus = (vital: number | null, thresholds: { good: number; poor: number }): 'good' | 'warning' | 'critical' => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <PerformanceCard
            ...
            status={
              !memoryUsage ? 'warning' :
              memoryUsage.percentage < 60 ? 'good' :
              memoryUsage.percentage < 80 ? 'warning' : 'critical'
            }
          ...
          <PerformanceCard
            ...
            status={
              !memoryUsage ? 'warning' :
              memoryUsage.used / 1024 / 1024 < 50 ? 'good' :
              memoryUsage.used / 1024 / 1024 < 100 ? 'warning' : 'critical'
            }
