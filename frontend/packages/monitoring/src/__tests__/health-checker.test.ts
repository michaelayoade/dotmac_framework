...
import { HealthChecker, HealthStatus, HealthResult, createHealthChecker } from '../health/health-checker';
...
describe('HealthChecker', () => {
  ...
  describe('Performance Tracking', () => {
    it('should track performance metrics over time', async () => {
      ...
      Date.now = jest.fn()
        .mockReturnValueOnce(1640995200000).mockReturnValueOnce(1640995200100) // 100ms
        .mockReturnValueOnce(1640995200200).mockReturnValueOnce(1640995200350) // 150ms
        .mockReturnValueOnce(1640995200400).mockReturnValueOnce(1640995200500); // 100ms
