...
export declare const trackAction: (action: string, component?: string, properties?: Record<string, any>) => void;
export declare const markPerformance: (name: string, metadata?: Record<string, any>) => void;
export declare const measurePerformance: (measureName: string, startMark: string, endMark?: string) => number | null;
