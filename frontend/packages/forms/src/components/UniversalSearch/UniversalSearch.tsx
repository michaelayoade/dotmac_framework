...
function FilterPanel({ filters, activeFilters, onUpdateFilter, onClearAll, theme }: FilterPanelProps) {
  return (
    <div className={cn(
          ...
          <div key={option.field}>
            <button
              ...
              className={cn(
                ...
                currentField === option.field && currentDirection === 'asc' && 'bg-primary-50 text-primary-700'
              )}
            >
              {option.label} (A-Z)
            </button>
            <button
              ...
              className={cn(
                'flex w-full px-4 py-2 text-sm text-left hover:bg-gray-100',
                currentField === option.field && currentDirection === 'desc' && 'bg-primary-50 text-primary-700'
              )}
            >
              {option.label} (Z-A)
            </button>
