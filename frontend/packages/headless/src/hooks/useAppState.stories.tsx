        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              <span className={`px-2 py-1 rounded text-sm ${sidebarOpen ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              <span className={`px-2 py-1 rounded text-sm ${filtersOpen ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
    ...
    return (
      <div className="p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button onClick={() => addSuccess('Operation completed successfully!')} className="bg-green-600">
            Add Success
          </Button>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div><strong>Has Filters:</strong> {hasActiveFilters ? 'Yes' : 'No'}</div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-sm space-y-1">
            ...
            <div><strong>Has Selection:</strong> {hasSelection ? 'Yes' : 'No'}</div>
            <div><strong>Selected Items:</strong> {selectedItems.join(', ') || 'None'}</div>
          </div>
        </div>
      </div>
    );
...
export const DataTableDemo: Story = {
  ...
  render: () => {
    ...
    const mockData = [
      'Document A.pdf', 'Report B.xlsx', 'Image C.jpg', 'Video D.mp4',
      'Archive E.zip', 'Presentation F.pptx', 'Spreadsheet G.csv',
      'Text H.txt', 'Code I.js', 'Data J.json'
    ];
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className={`px-3 py-2 rounded-md border bg-${portalConfigs[selectedPortal]?.color}-50 border-${portalConfigs[selectedPortal]?.color}-200`}>
              {theme}
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-sm space-y-1">
            <div><strong>Portal:</strong> {selectedPortal}</div>
            <div><strong>Theme:</strong> {portalConfigs[selectedPortal]?.theme}</div>
            <div><strong>Color Scheme:</strong> {portalConfigs[selectedPortal]?.color}</div>
          </div>
        </div>
...
function ContextDemo({ context, onRemove }: { context: string, onRemove: (context: string) => void }) {
