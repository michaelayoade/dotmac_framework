...
class AnalyticsService {
  ...
  private async initializeGoogleAnalytics(config: NonNullable<AnalyticsConfig['providers']['googleAnalytics']>): Promise<void> {
  ...
  private async initializeMixpanel(config: NonNullable<AnalyticsConfig['providers']['mixpanel']>): Promise<void> {
    const script = document.createElement('script');
  ...
  private async initializeAmplitude(config: NonNullable<AnalyticsConfig['providers']['amplitude']>): Promise<void> {
    const script = document.createElement('script');
  ...
  private async initializeHotjar(config: NonNullable<AnalyticsConfig['providers']['hotjar']>): Promise<void> {
  ...
  trackCustomerAction(action: string, customerId: string, properties: Record<string, any> = {}): void {
