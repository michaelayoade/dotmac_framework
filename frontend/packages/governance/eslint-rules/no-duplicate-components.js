...
module.exports = createRule({
  ...
  meta: {
    ...
    messages: {
      duplicateComponent: 'Component "{{componentName}}" should be imported from @dotmac/ui instead of creating a duplicate.',
      missingImport: 'Component "{{componentName}}" should be imported from @dotmac/ui.',
      suggestUnifiedImport: 'Import {{componentName}} from @dotmac/ui with portal variant: <{{componentName}} variant="{{portal}}" />'
    }
  },
  ...
  create(context, [options = {}]) {
    ...
    return {
      ...
      'FunctionDeclaration, VariableDeclarator[init.type="ArrowFunctionExpression"], VariableDeclarator[init.type="FunctionExpression"]'(node) {
...
function hasUnifiedImport(context, componentName) {
  ...
  return imports.some(importNode => {
    return importNode.source.value === '@dotmac/ui' &&
