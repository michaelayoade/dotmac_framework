...
export function UniversalPaymentMethodManager({
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.type === 'credit_card') {
        ...
        methodData.expiryYear = parseInt('20' + (formData.expiryDate?.split('/')[1] || '00')) || undefined;
  ...
  const getPaymentMethodIcon = (method: PaymentMethod) => {
    switch (method.type) {
      ...
      case 'bank_account':
        return <div className="w-5 h-5 bg-green-600 rounded flex items-center justify-center text-white text-xs font-bold">B</div>;
      case 'paypal':
        return <div className="w-5 h-5 bg-blue-500 rounded flex items-center justify-center text-white text-xs font-bold">P</div>;
      default:
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    {showSensitive.cvv ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                  </button>
                </div>
                {errors.cvv && (
                  <div className="flex items-center text-red-600 text-sm mt-1">
          ...
          <>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => setShowSensitive({ ...showSensitive, account: !showSensitive.account })}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600"
                >
                  {showSensitive.account ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                </button>
              </div>
