...
import { formatCurrency, getSupportedCurrencies, type SupportedCurrency } from '@dotmac/utils/formatting';
...
export const MultiCurrencyPaymentForm: React.FC<MultiCurrencyPaymentFormProps> = ({
  ...
  // Calculated values
  const convertedAmount = paymentCurrency === baseCurrency 
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {formatCurrency(parseFloat(paymentAmount), { currency: paymentCurrency as SupportedCurrency })}
                </span>
              </div>
              <div className="flex justify-between">
