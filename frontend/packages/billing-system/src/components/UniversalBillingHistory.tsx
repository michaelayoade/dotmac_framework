      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">{formatCurrency(stats.totalInvoiceAmount, currency)}</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">{formatCurrency(stats.totalPaymentAmount, currency)}</p>
          </div>
              ...
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th
                    ...
                    onClick={() => {
                      const newDirection = filters.sortField === 'date' && filters.sortDirection === 'desc' ? 'asc' : 'desc';
                  ...
                  <th
                    className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100"
                    onClick={() => {
                      const newDirection = filters.sortField === 'amount' && filters.sortDirection === 'desc' ? 'asc' : 'desc';
                      ...
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        {item.type === 'payment' && (
                          <>
                            ...
                            {item.status === 'completed' && onRefundPayment && portalType === 'admin' && (
                              <button
