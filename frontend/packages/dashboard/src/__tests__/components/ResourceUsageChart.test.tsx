...
import { ResourceUsageChart, ResourceUsagePresets } from '../../components/ResourceUsageChart/ResourceUsageChart';
...
describe('📈 ResourceUsageChart', () => {
  ...
  describe('Portal Variants', () => {
    ...
    it('should apply variant-specific colors to chart', () => {
      const { rerender } = render(
        <ResourceUsageChart {...defaultProps} variant="admin" />
      );
  ...
  describe('Resource Metrics Display', () => {
    ...
    it('should show trend indicators', () => {
      ...
      const trendElements = document.querySelectorAll('[class*="trend"]') ||
  ...
  describe('Timeframe Selection', () => {
    ...
    it('should highlight active timeframe', async () => {
      ...
      expect(oneHourButton).toHaveClass(expect.stringContaining('active') || expect.stringContaining('bg-'));
    });
