...
describe('📰 ActivityFeed', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render activity descriptions', () => {
      ...
      expect(screen.getByText('New user john@example.com successfully registered')).toBeInTheDocument();
  ...
  describe('Portal Variants', () => {
    it.each([
      ...
      const { container } = render(
        <ActivityFeed {...defaultProps} variant={variant as any} />
      );
    ...
    it('should apply variant-specific icon colors', () => {
      const { rerender, container } = render(
        <ActivityFeed {...defaultProps} variant="admin" />
      );
  ...
  describe('Portal Presets', () => {
    describe('Management Portal Activities', () => {
      ...
      it('should generate system alert activity', () => {
        const warningAlert = ActivityFeedPresets.management.systemAlert('Disk space low', 'warning');
    ...
    describe('Reseller Portal Activities', () => {
      it('should generate commission earned activity', () => {
        const activity = ActivityFeedPresets.reseller.commissionEarned(25.50, 'John Doe');
