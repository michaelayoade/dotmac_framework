...
export function BarcodeScanner({
  ...
  return (
    <div className={`barcode-scanner ${isScanning ? 'barcode-scanner--scanning' : ''} ${className}`}>
      ...
      <div className="scanner-controls">
        ...
        <button
          className="scanner-control"
          onClick={() => cameraManagerRef.current?.setFlash(!cameraManagerRef.current.getConfig().enableFlash)}
          title="Toggle Torch"
        >
          🔦
        </button>
