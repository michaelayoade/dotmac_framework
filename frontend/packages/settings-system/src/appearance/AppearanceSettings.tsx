...
export function AppearanceSettings({
  ...
  const updateAccessibility = (key: keyof AppearanceSettingsType['accessibility'], value: boolean) => {
    onUpdate({
      accessibility: {
              ...
              {primaryColors.map(color => (
                <button
                  ...
                  className={`relative w-12 h-12 rounded-lg ${color.class} transition-transform ${
                    readonly || isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110 cursor-pointer'
                  }`}
                  title={color.name}
                >
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => updateAccessibility('reducedMotion', !settings.accessibility.reducedMotion)}
                disabled={readonly || isLoading}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">More visible focus outlines for keyboard navigation</p>
              </div>
              <button
                onClick={() => updateAccessibility('focusIndicators', !settings.accessibility.focusIndicators)}
                disabled={readonly || isLoading}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => updateAccessibility('keyboardNavigation', !settings.accessibility.keyboardNavigation)}
                disabled={readonly || isLoading}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Enhanced labels and descriptions for screen readers</p>
              </div>
              <button
                onClick={() => updateAccessibility('screenReader', !settings.accessibility.screenReader)}
                disabled={readonly || isLoading}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="ml-3">
              ...
              <div className="mt-1 text-sm text-blue-700">
                <ul className="list-disc pl-5 space-y-1">
                  <li>System theme automatically switches between light and dark based on your OS settings</li>
