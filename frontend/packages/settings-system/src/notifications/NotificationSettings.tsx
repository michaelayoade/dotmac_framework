...
import { ContactMethod, NotificationPreference, NotificationSettings as NotificationSettingsType } from '../types';
            ...
            <div className="mb-4 p-4 bg-gray-50 border border-gray-200 rounded-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <input
                  type="text"
                  placeholder={
                    newContact.type === 'email' ? 'email@example.com' :
                    newContact.type === 'push' ? 'Device token' : '+1 (555) 123-4567'
                  }
