...
export const TerritoryMap: React.FC<TerritoryMapProps> = ({
  ...
  const territoryAnalytics = useMemo(() => {
    return territories.map((territory) => {
      ...
      const conversionRate = territoryLeads.length > 0 
        ? (territoryLeads.filter(l => l.status === 'converted').length / territoryLeads.length) * 100
        : 0;
              ...
              <div className="territory-details">
                ...
                <div className="metrics-grid">
                  <div className="metric">
                    ...
                    <value>{territory.actualCustomers} / {territory.customerCount}</value>
                  </div>
