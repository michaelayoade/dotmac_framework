...
export type AlertCategory = 'connectivity' | 'performance' | 'security' | 'configuration' | 'hardware';
...
export const NetworkAlertsList: React.FC<NetworkAlertsListProps> = ({
  ...
  const handleBulkAction = useCallback((action: 'acknowledge' | 'resolve' | 'suppress' | 'delete') => {
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="space-y-1">
                  {(['active', 'acknowledged', 'resolved', 'suppressed'] as AlertStatus[]).map(status => (
              ...
              <div>
                ...
                <div className="space-y-1">
                  {(['connectivity', 'performance', 'security', 'configuration', 'hardware'] as AlertCategory[]).map(category => (
