...
export interface KanbanBoardProps {
  ...
  cardComponent?: React.ComponentType<{ card: KanbanCard; onEdit?: () => void; onDelete?: () => void }>;
  showAddCard?: boolean;
            ...
            <div key={column.id} className="flex-shrink-0 w-80">
              ...
              {showColumnLimits && (
                <div className="mb-3 text-xs text-gray-500 px-3">
                  {stats.totalValue > 0 && (
                    <div>Value: ${stats.totalValue.toLocaleString()}</div>
                  )}
                  {column.limit && (
        ...
        >
          <div className="space-y-4">
            ...
            <Select
              ...
              onChange={(value) => setNewCardData(prev => ({ ...prev, priority: value as KanbanCard['priority'] }))}
            >
