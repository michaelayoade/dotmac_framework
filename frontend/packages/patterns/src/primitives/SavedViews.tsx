...
function SavedViewsImpl({
  ...
  const groupedViews = useMemo(() => {
    ...
    filteredViews.forEach(view => {
      const category = view.isDefault ? 'default' : 
                     view.isPublic ? 'public' : 
                     'private';
  ...
  }, [formData, currentFilters, currentSorting, currentColumns, editingView, onViewSave, onViewUpdate]);

  // Handle load view
  const handleLoadView = useCallback((view: SavedViewConfig) => {
    onViewLoad?.(view);
  ...
  const handleDuplicateView = useCallback((view: SavedViewConfig) => {
  ...
  // Handle share view
  const handleShareView = useCallback((viewId: string, isPublic: boolean) => {
  ...
  // Handle export view
  const handleExportView = useCallback((view: SavedViewConfig, format: 'json' | 'url') => {
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    ...
                    {currentColumns && (
                      <div>Columns: {currentColumns.length} selected</div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-muted-foreground space-y-1">
                        ...
                        {view.createdBy && (
                          <div>Created by {view.createdBy}</div>
                        )}
                      </div>
                    </div>
        ...
        {filteredViews.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">
              {searchQuery ? 'Try adjusting your search criteria.' : 'Save your first view to get started.'}
            </p>
