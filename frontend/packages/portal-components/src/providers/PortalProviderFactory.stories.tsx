...
const DemoContent = () => (
  <div style={{ padding: 24 }}>
    ...
    <div style={{ marginTop: 24, display: 'grid', gap: 12 }}>
      ...
      <div style={{ height: 120, border: '1px dashed #ccc', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        Table/Content Area
      </div>
      <div style={{ height: 48, border: '1px solid var(--auth-border)', display: 'flex', alignItems: 'center', padding: '0 12px' }}>
...
export const DensityAndThemeMatrix: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Toggle density (compact/cozy/comfortable) and color scheme (light/dark/system) to validate design tokens across portals.',
      },
    },
  },
};
