...
import { Search, Filter, RefreshCw, Power, PowerOff, RotateCw, Settings, AlertCircle } from 'lucide-react';
          ...
          {filteredPlugins.map((plugin) => {
            ...
            return (
              <PluginCard
                ...
                onSelect={allowBulkOperations ? (selected) => handlePluginSelect(pluginKey, selected) : undefined}
