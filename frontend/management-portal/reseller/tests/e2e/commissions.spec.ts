...
test.describe('Commissions Management', () => {
  ...
  test('should approve single commission', async ({ page }) => {
    ...
    const calculatedCommission = page
      .locator(
        '[data-testid="commission-row"]:has([data-testid="commission-status"]:has-text("CALCULATED"))'
      )
      .first();
  ...
  test('should bulk approve commissions', async ({ page }) => {
    ...
    const firstThree = checkboxes
      .first()
      .locator('..', { hasText: 'CALCULATED' })
      .locator('[data-testid="commission-checkbox"]')
      .first();
  ...
  test('should process approved commission', async ({ page }) => {
    ...
    const approvedCommission = page
      .locator(
        '[data-testid="commission-row"]:has([data-testid="commission-status"]:has-text("APPROVED"))'
      )
      .first();
  ...
  test('should show commission calculation details', async ({ page }) => {
    ...
    if (deductionCount > 0) {
      ...
      await expect(
        deductions.first().locator('[data-testid="deduction-description"]')
      ).toBeVisible();
