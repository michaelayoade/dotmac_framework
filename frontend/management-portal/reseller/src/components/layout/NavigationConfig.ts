...
export const navigationConfig: NavigationItem[] = [
  { name: 'Dashboard', href: '/dashboard', icon: LayoutDashboard },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: Target,
        permission: Permission.MANAGE_ONBOARDING,
      },
      {
        name: 'Applications',
        ...
        icon: FileText,
        badge: '3',
        permission: Permission.PROCESS_APPLICATIONS,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'Calculations',
        href: '/commissions/calculations',
        icon: BarChart3,
        permission: Permission.VIEW_COMMISSIONS,
      },
      {
        name: 'Disputes',
        href: '/commissions/disputes',
        icon: Shield,
        badge: '2',
        permission: Permission.MANAGE_COMMISSION_DISPUTES,
      },
    ],
  },
  {
...
export function findCurrentNavigation(
