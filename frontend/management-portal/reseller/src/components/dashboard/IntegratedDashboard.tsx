      ...
      <div className='col-span-4'>
        <div className='bg-white p-6 rounded-lg shadow-sm border'>
          ...
          <div className='flex flex-wrap gap-4'>
            <Button variant='outline' onClick={() => console.log('Add new partner')}>
              Add New Partner
            </Button>
            <Button variant='outline' onClick={() => console.log('Process payouts')}>
              Process Payouts
            </Button>
            <Button variant='outline' onClick={() => console.log('Generate reports')}>
              Generate Reports
            </Button>
            <Button variant='outline' onClick={() => console.log('Territory management')}>
