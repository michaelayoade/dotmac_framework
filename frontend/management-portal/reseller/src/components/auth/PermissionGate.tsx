...
export function CanManageResellers({
  children,
  fallback,
  onUnauthorized,
}: BusinessPermissionGateProps) {
  return (
    <PermissionGate
...
export function CanApproveCommissions({
  children,
  fallback,
  onUnauthorized,
}: BusinessPermissionGateProps) {
...
export function CanManageTerritories({
  children,
  fallback,
  onUnauthorized,
}: BusinessPermissionGateProps) {
...
export function DepartmentOnly({
  children,
  department,
  fallback,
  onUnauthorized,
  ...
  return (
    <PermissionGate department={department} fallback={fallback} onUnauthorized={onUnauthorized}>
      {children}
    </PermissionGate>
  );
}
