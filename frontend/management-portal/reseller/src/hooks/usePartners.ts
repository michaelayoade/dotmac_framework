...
export function useUpdatePartner() {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      queryClient.setQueryData(queryKeys.partnersDetail(variables.id), data);
...
export function useApprovePartner() {
  ...
  return useMutation({
    ...
    onSuccess: (data, id) => {
      ...
      queryClient.setQueryData(queryKeys.partnersDetail(id), data);
...
export function useSuspendPartner() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, { id }) => {
      // Update the specific partner in cache with server response
      queryClient.setQueryData(queryKeys.partnersDetail(id), _data);
...
export function useUpdatePartnerTier() {
  ...
  return useMutation({
    mutationFn: ({ id, tier }: { id: string; tier: string }) => API.partners.updateTier(id, tier),
    onSuccess: (data, { id }) => {
      // Update the specific partner in cache
      queryClient.setQueryData(queryKeys.partnersDetail(id), data);
...
export function useOptimisticPartnerUpdate() {
  ...
  const updatePartnerOptimistically = (id: string, updates: Partial<Partner>) => {
    queryClient.setQueryData(queryKeys.partnersDetail(id), (oldData: any) => {
