    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-md w-full space-y-8'>
        ...
        <div className='text-center'>
          ...
          <h2 className='mt-6 text-3xl font-bold text-gray-900'>Management Portal</h2>
          <p className='mt-2 text-sm text-gray-600'>Reseller Network Management Platform</p>
          <div className='mt-2 p-2 bg-blue-50 border border-blue-200 rounded-lg'>
            <p className='text-xs text-blue-700 font-medium'>🔒 Authorized Personnel Only</p>
          </div>
        </div>
        ...
        <form className='mt-8 space-y-6' onSubmit={handleSubmit}>
          ...
          <div className='mt-6 p-4 bg-management-50 border border-management-200 rounded-lg'>
            ...
            <p className='text-xs text-management-700 mb-2'>Channel Manager credentials:</p>
          ...
          <div className='mt-4 p-3 bg-gray-100 border border-gray-200 rounded-lg'>
            <div className='flex items-start'>
              ...
              <div className='text-xs text-gray-600'>
                ...
                <p>
                  This portal provides access to sensitive partner and commission data. All
                  activities are logged and monitored for compliance.
                </p>
              </div>
            </div>
          </div>
