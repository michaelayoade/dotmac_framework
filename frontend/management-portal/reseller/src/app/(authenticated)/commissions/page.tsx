...
export default function CommissionsPage() {
    ...
    try {
      ...
      const mockPayments: CommissionPayment[] = [
        ...
        },
        {
          ...
          deductions: [{ type: 'TAX', description: 'Federal withholding', amount: 6417 }],
        ...
        },
        {
          ...
          deductions: [{ type: 'TAX', description: 'Federal withholding', amount: 5693 }],
  ...
  const filteredPayments = payments.filter((payment) => {
    const matchesStatus =
      statusFilter === 'all' || payment.status.toLowerCase().includes(statusFilter.toLowerCase());
    const matchesSearch =
              ...
              {filteredPayments.map((payment) => (
                <tr key={payment.id} className='hover:bg-gray-50'>
                  ...
                  <td className='px-6 py-4 whitespace-nowrap'>
                    <div className='flex items-center'>
                      <div>
                        ...
                        <div className='text-sm text-gray-500'>{payment.payment_number}</div>
                      </div>
                  ...
                  <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-900'>
                    ...
                    <div className='text-xs text-gray-500 mt-1'>{payment.sales_count} sales</div>
                  </td>
                  ...
                  <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900'>
                    ...
                    {payment.deductions.length > 0 && (
                      <div className='text-xs text-red-600 mt-1'>
                        -{formatCurrency(payment.deductions.reduce((sum, d) => sum + d.amount, 0))}{' '}
                        deductions
                      </div>
                    )}
                  </td>
          ...
          <div className='space-y-3'>
            {summary.top_earners.map((earner, index) => (
              <div key={earner.partner_name} className='flex items-center justify-between'>
                ...
                <div className='font-bold text-commission-600'>{formatCurrency(earner.amount)}</div>
              </div>
            ))}
          </div>
        </div>
