...
export function MFASetup({ onSetupComplete, onCancel }: MFASetupProps) {
  ...
  const [currentStep, setCurrentStep] = useState<'method' | 'setup' | 'verify' | 'backup'>(
    'method'
  );
        ...
        >
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-500'>Receive codes via text message (Coming Soon)</p>
            </div>
          </div>
        </button>
      </div>
  ...
  const renderBackupCodes = () => (
    <div className='space-y-6'>
      <div className='text-center'>
        ...
        <p className='text-gray-600 mt-2'>
          Save these backup codes in a secure place. You can use them if you lose access to your
          authenticator app.
        </p>
      </div>
