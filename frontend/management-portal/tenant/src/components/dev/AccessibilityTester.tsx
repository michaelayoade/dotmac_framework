...
export function AccessibilityTesterComponent({
  ...
  const runAudit = useCallback(
    async (testerInstance?: AccessibilityTester) => {
            ...
            <div className='p-3'>
              ...
              {!isLoading && !auditResult && (
                <div className='text-center py-8'>
                  ...
                  <AccessibleButton onClick={() => runAudit()} variant='primary' size='sm'>
                    Run Audit
                  </AccessibleButton>
                </div>
              )}
              ...
              {auditResult && (
                <div className='space-y-3'>
                  ...
                  <div className='text-center'>
                    ...
                    <div className='text-xs text-gray-600'>WCAG {auditResult.wcagLevel} Level</div>
                  </div>
                    ...
                    <div className='max-h-48 overflow-y-auto space-y-1'>
                      {auditResult.issues.map((issue, index) => (
                        <button
                          ...
                          className={`w-full text-left p-2 rounded border text-xs transition-colors ${getIssueColor(
                            issue.impact
                        ...
                        >
                          ...
                          <div className='text-gray-600 mt-1 truncate'>{issue.selector}</div>
                        </button>
                      ))}
                    </div>
                  )}
          ...
          <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
            <div className='bg-white rounded-lg shadow-xl max-w-md w-full m-4'>
              <div className='p-4 border-b'>
                ...
                <div
                  className={`text-sm px-2 py-1 rounded mt-2 inline-block ${getIssueColor(
