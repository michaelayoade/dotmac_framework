            ...
            {!isLoading && selectedTab === 'performance' && report && (
              <div className='space-y-4'>
                ...
                <div className='text-center'>
                  <div
                    className={`inline-block px-3 py-1 rounded-full text-lg font-bold ${getScoreColor(report.score)}`}
                  >
                    {report.score}/100
                  </div>
                  ...
                  <div className='grid grid-cols-2 gap-2 text-xs'>
                    {report.metrics.lcp && (
                      <div className='bg-gray-50 p-2 rounded'>
                        ...
                        <div
                          className={
                            report.status.lcp === 'good' ? 'text-green-600' : 'text-red-600'
                          }
                        >
                    ...
                    {report.metrics.fid && (
                      <div className='bg-gray-50 p-2 rounded'>
                        ...
                        <div
                          className={
                            report.status.fid === 'good' ? 'text-green-600' : 'text-red-600'
                          }
                        >
                    ...
                    {report.metrics.cls && (
                      <div className='bg-gray-50 p-2 rounded'>
                        ...
                        <div
                          className={
                            report.status.cls === 'good' ? 'text-green-600' : 'text-red-600'
                          }
                        >
                    ...
                    {report.metrics.fcp && (
                      <div className='bg-gray-50 p-2 rounded'>
                        ...
                        <div className='text-gray-700'>{formatTime(report.metrics.fcp)}</div>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex justify-between text-xs'>
                    ...
                    <span className='font-mono'>{formatTime(assetMetrics.fontLoadTime)}</span>
                  </div>
                  <div className='flex justify-between text-xs'>
                  ...
                  <div className='flex justify-between text-xs'>
                    ...
                    <span className='font-mono'>{formatTime(assetMetrics.loadingTime)}</span>
                  </div>
                </div>
              </div>
            )}
...
export function usePerformanceMonitoring() {
  ...
  const measureDuration = useCallback(
    (startMark: string, endMark: string, measureName: string): number => {
      if (!isDev) return 0;
