...
export const LazyAlertModal = createLazyComponent(() => import('@/components/modals/AlertModal'), {
  preload: true,
});

export const LazyFormModal = createLazyComponent(() => import('@/components/modals/FormModal'), {
  preload: getLoadingStrategy() !== 'minimal',
});
