...
export default function LoginPage() {
  ...
  useEffect(() => {
    announceToScreenReader(
      'Login page loaded. Please enter your credentials to access the tenant portal.',
      'polite'
    );
  }, []);
    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-md w-full space-y-8'>
        ...
        <header className='text-center'>
          ...
          <h1 className='mt-6 text-3xl font-bold text-gray-900'>Sign in to your tenant portal</h1>
          <p className='mt-2 text-sm text-gray-600'>Access your DotMac ISP Platform instance</p>
        </header>
