                      ...
                      {typeof value === 'boolean' ? (
                        <div className='flex items-center'>
                          <input
                            ...
                            onChange={(e) =>
                              handleSettingChange(activeConfig.category, key, e.target.checked)
                            }
                        ...
                        <div className='flex items-center space-x-3'>
                          <input
                            ...
                            value={displayValue}
                            onChange={(e) =>
                              handleSettingChange(activeConfig.category, key, e.target.value)
                            }
                            disabled={!activeConfig.editable_by_tenant}
              ...
              {activeConfig.editable_by_tenant && (
                <div className='mt-8 flex items-center justify-between pt-6 border-t border-gray-200'>
                  ...
                  <div className='flex space-x-3'>
                    <button
                      onClick={() =>
                        setChanges((prev) => ({ ...prev, [activeConfig.category]: {} }))
                      }
