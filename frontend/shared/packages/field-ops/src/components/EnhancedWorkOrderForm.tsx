...
import { Save, X, AlertCircle, Camera, MapPin, Plus, Trash2, Loader2 } from 'lucide-react';
      ...
      <div className='space-y-4 max-w-4xl mx-auto'>
        ...
        <Card className='p-6'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <Button variant='ghost' size='sm' onClick={onCancel} className='w-10 h-10 p-0'>
              <X className='w-5 h-5' />
            </Button>
          </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm'>
                <div>
                  ...
                  <div className='text-blue-900'>
                    {mlPredictions.estimatedDuration.toFixed(1)} hours
                  </div>
                </div>
                {mlPredictions.optimalRoute && (
                  <div>
                    ...
                    <div className='text-blue-900'>
                      {mlPredictions.optimalRoute.estimatedTime} minutes
                    </div>
                  </div>
                )}
                <div>
            ...
            <div className='bg-gray-50 rounded-lg p-4 flex items-center justify-between'>
              ...
              <div className='flex items-center space-x-2'>
                {enableLocationTracking && selectedCustomer.coordinates && (
                  <Button variant='ghost' size='sm' onClick={() => setShowLocationMap(true)}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
          ...
          <Card className='p-6'>
            <div className='flex space-x-4'>
              ...
              <Button type='submit' disabled={loading || !selectedCustomer} className='flex-1'>
