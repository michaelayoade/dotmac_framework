  ...
  const steps: WizardStep[] = [
    ...
    },
    {
      ...
      isComplete: !!(
        ...
        formData.adminUser.firstName &&
        formData.adminUser.lastName
      ),
    },
    {
      id: 'branding',
    ...
    (stepIndex: number): boolean => {
      ...
      switch (stepIndex) {
        ...
        case 1: // Admin User
          ...
          if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.adminUser.email))
        ...
        return (
          <div className='space-y-6'>
            ...
            <div>
              ...
              <div className='bg-gray-50 p-4 rounded space-y-2'>
                <p>
                  <strong>Name:</strong> {formData.adminUser.firstName}{' '}
                  {formData.adminUser.lastName}
                </p>
                <p>
                  <strong>Email:</strong> {formData.adminUser.email}
                </p>
                {formData.adminUser.phone && (
                  <p>
                    <strong>Phone:</strong> {formData.adminUser.phone}
                  </p>
                )}
              </div>
            </div>
