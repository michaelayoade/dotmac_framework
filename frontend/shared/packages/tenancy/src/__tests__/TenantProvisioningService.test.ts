...
describe('TenantProvisioningService', () => {
  ...
  describe('provisionTenant', () => {
    it('should provision a tenant successfully', async () => {
      ...
      expect(mockApiClient.request).toHaveBeenCalledWith('/api/v1/tenants/provision', {
        method: 'POST',
  ...
  describe('getTenant', () => {
    it('should retrieve tenant details', async () => {
      ...
      expect(mockApiClient.request).toHaveBeenCalledWith(`/api/v1/tenants/${tenantId}`, {
        method: 'GET',
      });
    });
  });
  ...
  describe('suspendTenant', () => {
    it('should suspend a tenant', async () => {
      ...
      expect(mockApiClient.request).toHaveBeenCalledWith(`/api/v1/tenants/${tenantId}/suspend`, {
        method: 'POST',
