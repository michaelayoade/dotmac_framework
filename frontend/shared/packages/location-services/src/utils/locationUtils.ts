 ...
 */
export function calculateDistance(location1: LocationData, location2: LocationData): number {
 ...
 */
export function calculateBearing(from: LocationData, to: LocationData): number {
 ...
 */
export function calculateMidpoint(location1: LocationData, location2: LocationData): LocationData {
  const φ1 = (location1.latitude * Math.PI) / 180;
  const φ2 = (location2.latitude * Math.PI) / 180;
  const Δλ = ((location2.longitude - location1.longitude) * Math.PI) / 180;
 ...
 */
export function formatCoordinates(location: LocationData, precision: number = 6): string {
 ...
 */
export function isLocationValid(location: LocationData, maxAgeMs: number = 60000): boolean {
