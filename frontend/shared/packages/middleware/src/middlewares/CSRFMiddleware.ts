...
export function createCSRFMiddleware(
  ...
  return async (context: MiddlewareContext) => {
    ...
    // Get CSRF tokens
    const requestCsrfToken = request.headers.get(csrfConfig.headerName) || context.csrfToken;
 ...
 */
export function createCSRFTokenMiddleware(cookieName: string = 'csrf-token'): MiddlewareFunction {
