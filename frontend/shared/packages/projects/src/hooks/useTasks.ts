...
export function useTasks(): UseTasksResult {
  ...
  const createTask = useCallback(
    async (projectId: string, data: TaskCreate): Promise<ProjectTask> => {
      try {
        setError(null);
  ...
  const updateTask = useCallback(
    async (taskId: string, data: TaskUpdate): Promise<ProjectTask> => {
      try {
        setError(null);
  ...
  const addTaskComment = useCallback(
    async (taskId: string, comment: string): Promise<void> => {
      try {
        setError(null);
  ...
  const getTasksByProject = useCallback(
    async (projectId: string, filters?: TaskFilters): Promise<ProjectTask[]> => {
      try {
        setLoading(true);
        setError(null);
  ...
  const getTasksByUser = useCallback(
    async (userId: string, filters?: TaskFilters): Promise<ProjectTask[]> => {
      try {
        setLoading(true);
        setError(null);
