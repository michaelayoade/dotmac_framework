...
export function useProjects(): UseProjectsResult {
  ...
  const updateProject = useCallback(
    async (projectId: string, data: ProjectUpdate): Promise<Project> => {
      try {
        setError(null);
  ...
  const changeProjectStatus = useCallback(
    async (projectId: string, status: ProjectStatus): Promise<void> => {
      try {
        setError(null);
  ...
  const assignProjectManager = useCallback(
    async (projectId: string, managerId: string): Promise<void> => {
      try {
        setError(null);
  ...
  const getProjectAnalytics = useCallback(
    async (filters?: ProjectFilters): Promise<ProjectAnalytics> => {
      try {
