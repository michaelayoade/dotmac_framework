...
import { Plus, Filter, User, Calendar, Clock, Flag, MessageSquare, Paperclip } from 'lucide-react';
            ...
            >
              ...
              <div className={`p-3 rounded-t-lg border-b ${config.headerColor}`}>
                <div className='flex items-center justify-between'>
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-medium ${config.textColor} bg-white bg-opacity-50`}
                  >
                    {statusTasks.length}
                  </span>
                </div>
                ...
                {statusTasks.map((task) => (
                  ...
                  >
                    ...
                    <div className='flex items-start justify-between mb-2'>
                      <h4 className='font-medium text-sm line-clamp-2'>{task.task_title}</h4>
