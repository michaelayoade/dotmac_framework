...
export function MobileLayout({
  ...
  const contentClasses = clsx('mobile-content', 'flex-1', 'overflow-auto', 'relative', {
  ...
  return (
    ...
    >
      ...
      {showHeader && (
        <div
          className={clsx('mobile-header', 'flex-shrink-0', 'z-40', {
            'pt-safe': safeArea,
          })}
        >
          {header}
      ...
      {showNavigation && navigationPosition === 'top' && (
        <div
          className={clsx('mobile-navigation', 'mobile-navigation-top', 'flex-shrink-0', 'z-30')}
        >
          {navigation}
        </div>
      )}
