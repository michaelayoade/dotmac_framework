    ...
    <div className={clsx('mobile-input-container', 'w-full', className)}>
      ...
      <div className='relative'>
        ...
        <div className='absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center space-x-2'>
          ...
          {/* Right Icon */}
          {rightIcon && <div className='text-gray-400 pointer-events-none'>{rightIcon}</div>}
        </div>

        {/* Floating Label */}
        {variant === 'minimal' && label && (
          <label
            className={clsx('absolute left-0 transition-all duration-200 pointer-events-none', {
...
export function MobileSelect({
  ...
  return (
    <div className={clsx('mobile-select-container', 'relative', className)}>
      ...
      >
        <span className={clsx('text-base', selectedOption ? 'text-gray-900' : 'text-gray-400')}>
          ...
          <div className='absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-60 overflow-auto'>
            {options.map((option) => (
              ...
              >
                ...
                {option.value === value && (
                  <svg
                    className='w-4 h-4 inline ml-2 text-blue-600'
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
                  >
...
export function MobileCheckbox({
  ...
  return (
    ...
    >
      ...
      {/* Label */}
      {label && (
        <span className={clsx('text-base flex-1', disabled ? 'text-gray-400' : 'text-gray-900')}>
          {label}
        </span>
      )}
    </label>
...
export function MobileSwitch({
  ...
  return (
    ...
    >
      {/* Label */}
      {label && (
        <span className={clsx('text-base mr-3', disabled ? 'text-gray-400' : 'text-gray-900')}>
          {label}
        </span>
      )}
      ...
      <div className='relative flex-shrink-0'>
        ...
        {/* Track */}
        <div
          className={clsx('rounded-full transition-all duration-200 border-2', sizes.container, {
