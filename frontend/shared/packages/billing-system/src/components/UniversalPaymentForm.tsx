          ...
          <React.Fragment key={s}>
            <div
              className={cn(
                ...
                currentStep === s ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'
              )}
            >
              {index + 1}
            </div>
            ...
            <div className='bg-gray-50 rounded-lg p-4'>
              <div className='flex items-center'>
                ...
                <div>
                  ...
                  <div className='text-sm text-gray-500'>
                    {selectedPm.expiryMonth &&
                      selectedPm.expiryYear &&
                      `Expires ${selectedPm.expiryMonth}/${selectedPm.expiryYear}`}
                  </div>
                </div>
              </div>
            </div>
        ...
        {paymentMethod === 'existing' ? (
          <div className='flex justify-between'>
            ...
            <span className='font-medium'>
              ...
              {existingPaymentMethods.find((pm) => pm.id === selectedPaymentMethodId)?.last4 ||
                existingPaymentMethods.find((pm) => pm.id === selectedPaymentMethodId)?.lastFour}
            </span>
          </div>
        ) : (
          <div className='flex justify-between'>
