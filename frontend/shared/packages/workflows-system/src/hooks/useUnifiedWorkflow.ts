...
export const useUnifiedWorkflow = standard_exception_handler(
  (options: UseUnifiedWorkflowOptions): UseUnifiedWorkflowReturn => {
    ...
    const createDefinition = useCallback(
      async (definition: Partial<WorkflowDefinition>) => {
    ...
    const updateDefinition = useCallback(
      async (id: string, updates: Partial<WorkflowDefinition>) => {
    ...
    const createInstance = useCallback(
      async (definitionId: string, context: WorkflowContext) => {
    ...
    const executeStep = useCallback(
      async (instanceId: string, stepId: string, input?: unknown) => {
    ...
    const skipStep = useCallback(
      async (instanceId: string, stepId: string) => {
    ...
    const createRule = useCallback(
      async (rule: Partial<BusinessRule>) => {
    ...
    const updateRule = useCallback(
      async (id: string, updates: Partial<BusinessRule>) => {
    ...
    const testRules = useCallback(
      async (context: WorkflowContext) => {
        ...
        return await ruleEngine.executeRules(
          state.rules.filter((r) => r.status === 'active'),
          ruleContext
        );
      },
