      ...
      return (
        <div className='form-section'>
          {Object.entries(formConfig.schema.properties || {}).map(([key, property]) => {
            const isRequired =
              Array.isArray(formConfig.schema.required) && formConfig.schema.required.includes(key);
      ...
      <div key={section.title} className='form-section'>
        ...
        >
          {section.fields.map((fieldKey) => {
            ...
            const isRequired =
              Array.isArray(formConfig.schema.required) &&
  ...
  return (
    <div className={clsx('workflow-form-step', className)}>
      <div className='form-header'>
        ...
        {step.description && <p className='form-description'>{step.description}</p>}
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={clsx('workflow-form', formConfig.layout)}>
        ...
        <div className='form-actions'>
          ...
          <div className='form-status'>
            {isDirty && !isSubmitting && <span className='status-message'>Unsaved changes</span>}
