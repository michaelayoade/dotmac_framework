...
import { WorkflowDefinition, WorkflowStepConfig, WorkflowConfig } from '../types';
...
const STEP_TYPES = {
  form: {
    ...
    defaultFields: [{ key: 'input', label: 'User Input', type: 'text', required: true }],
  },
  approval: {
    label: 'Approval Step',
    icon: Check,
    color: 'bg-green-100 text-green-800',
    defaultFields: [{ key: 'approver', label: 'Approver', type: 'select', required: true }],
  },
  action: {
    label: 'Action Step',
    icon: Zap,
    color: 'bg-orange-100 text-orange-800',
    defaultFields: [{ key: 'action_type', label: 'Action Type', type: 'select', required: true }],
  },
  conditional: {
  ...
  review: {
    ...
    defaultFields: [{ key: 'reviewer', label: 'Reviewer', type: 'select', required: true }],
  },
};
                  ...
                  {designerSteps.length === 0 && (
                    <div className='flex items-center justify-center h-64 text-gray-500'>
                      <div className='text-center'>
                        ...
                        <p className='text-sm'>
                          Drag steps from the toolbar to build your workflow
                        </p>
                      </div>
                    </div>
                  )}
      ...
      <div className='flex-1 p-4 space-y-4 overflow-auto'>
        ...
        <div className='flex items-center space-x-3'>
          <input
            ...
            disabled={readOnly}
          />
          <label htmlFor='skippable' className='text-sm font-medium'>
            Allow Skip
          </label>
        </div>
