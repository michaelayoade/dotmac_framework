        ...
        <div>
          ...
          <p className='text-sm text-gray-500 mt-1'>
            {mergedOptions.accept && mergedOptions.accept.length > 0 && (
              <>
                Accepted types: {mergedOptions.accept.join(', ')}
                <br />
              </>
            )}
            ...
            {mergedOptions.maxFiles && <>Max files: {mergedOptions.maxFiles}</>}
          </p>
        </div>
      </div>
    </div>
  ...
  const renderFilePreview = () => {
    ...
    return (
      <div className='mt-4 space-y-2'>
        ...
        {remainingCount > 0 && (
          <p className='text-xs text-gray-500 text-center'>+ {remainingCount} more files</p>
        )}
      </div>
    );
  };
