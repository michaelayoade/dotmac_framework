    ...
    return (
      <div className={`${className} bg-white rounded-lg border border-gray-200 p-8`}>
        <div className='text-center'>
          ...
          <h3 className='text-lg font-medium text-gray-900 mb-2'>Select an image to process</h3>
      ...
      <div className='border-b border-gray-200 p-4'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center space-x-3'>
            ...
            {originalImage && <span className='text-sm text-gray-500'>{originalImage.name}</span>}
          </div>
