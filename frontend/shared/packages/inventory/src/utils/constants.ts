...
export const STATUS_TRANSITIONS = {
  ...
  [ItemStatus.RESERVED]: [ItemStatus.AVAILABLE, ItemStatus.ALLOCATED, ItemStatus.IN_REPAIR],
  [ItemStatus.ALLOCATED]: [ItemStatus.IN_USE, ItemStatus.AVAILABLE, ItemStatus.IN_REPAIR],
  [ItemStatus.IN_USE]: [
    ItemStatus.AVAILABLE,
    ItemStatus.IN_REPAIR,
    ItemStatus.LOST,
  ...
  [ItemStatus.IN_REPAIR]: [ItemStatus.AVAILABLE, ItemStatus.RETIRED, ItemStatus.QUARANTINED],
  [ItemStatus.QUARANTINED]: [ItemStatus.AVAILABLE, ItemStatus.RETIRED, ItemStatus.IN_REPAIR],
  [ItemStatus.RETIRED]: [],
