...
// Migration Tools
export { migrateComponents, migrateProviders, analyzeProject } from '../bin/dotmac-migrate';
...
export const PORTALS = ['admin', 'customer', 'reseller', 'technician', 'management'] as const;
...
export function hasAllowedPrefix(
  ...
  allowedPrefixes: string[] = [...ALLOWED_LOCAL_PREFIXES]
): boolean {
