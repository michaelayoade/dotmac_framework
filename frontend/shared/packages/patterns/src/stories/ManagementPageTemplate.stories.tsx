...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A comprehensive management page template with metrics, filters, and actions. Supports all portal types with customizable theming and density settings.',
      },
    },
  },
  decorators: [
...
export const PerformanceTest: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Performance test with many metrics and filters to ensure the template handles large datasets efficiently.',
      },
    },
  },
};
