...
jest.mock('@dotmac/primitives', () => ({
  ...
  Input: ({ onChange, value, placeholder, ...props }: any) => (
    <input onChange={(e) => onChange?.(e)} value={value} placeholder={placeholder} {...props} />
  ),
...
describe('ManagementPageTemplate', () => {
  ...
  describe('Interactions', () => {
    it('calls onAction when action button is clicked', async () => {
      ...
      render(<ManagementPageTemplate {...defaultProps} onAction={mockOnAction} />);
    ...
    it('calls onFilterChange when filter values change', async () => {
      ...
      render(<ManagementPageTemplate {...defaultProps} onFilterChange={mockOnFilterChange} />);
    ...
    it('calls onExport when export is triggered', async () => {
      ...
      render(<ManagementPageTemplate {...defaultProps} onExport={mockOnExport} />);
    ...
    it('handles search input correctly', async () => {
      ...
      render(<ManagementPageTemplate {...defaultProps} onSearch={mockOnSearch} />);
    ...
    it('handles refresh action', async () => {
      ...
      render(<ManagementPageTemplate {...defaultProps} onRefresh={mockOnRefresh} />);
  ...
  describe('Auto-refresh', () => {
    ...
    it('does not auto-refresh when disabled', () => {
      ...
      render(
        <ManagementPageTemplate {...defaultProps} config={config} onRefresh={mockOnRefresh} />
      );
  ...
  describe('Loading States', () => {
    it('shows loading skeleton when isLoading is true', () => {
      render(<ManagementPageTemplate {...defaultProps} isLoading={true} />);
    ...
    it('shows error state when error is provided', () => {
      ...
      render(<ManagementPageTemplate {...defaultProps} error={error} />);
