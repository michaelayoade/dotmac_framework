...
import { Edit3, Check, X, MessageSquare, Clock, User, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className='p-4'>
        <div className='flex items-start justify-between mb-3'>
          <div className='flex items-center gap-2'>
            ...
            <div>
              <div className='text-sm font-medium text-gray-900'>{suggestion.author.name}</div>
    ...
    <div className='suggestions-panel h-full flex flex-col bg-white'>
      ...
      <div className='panel-header p-4 border-b'>
        <div className='flex items-center justify-between mb-4'>
          ...
          <div className='text-sm text-gray-600'>{suggestions.length} total</div>
        </div>
        ...
        {sortedSuggestions.length > 0 ? (
          ...
          <div className='empty-state flex flex-col items-center justify-center h-full text-gray-500 p-8'>
            ...
            <p className='text-sm text-center'>
              ...
              {filter === 'all' &&
                'Suggestions will appear here when collaborators propose changes.'}
            </p>
          </div>
        )}
      </div>
      ...
      <div className='panel-footer p-4 border-t bg-gray-50'>
        <div className='text-xs text-gray-600'>
          ...
          <p>
            Suggestions allow collaborators to propose edits without directly modifying the
            document.
          </p>
        </div>
      </div>
