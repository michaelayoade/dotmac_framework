  ...
  describe('Configuration Validation', () => {
    ...
    it('should detect invalid health configuration', () => {
      ...
      expect(result.errors).toContainEqual(
        expect.stringMatching(/Health interval must be positive/)
      );
      expect(result.errors).toContainEqual(
        expect.stringMatching(/Health retries must be non-negative/)
      );
      expect(result.errors).toContainEqual(
        expect.stringMatching(/Health timeout must be positive/)
      );
    });
