      ...
      <div className={`space-y-6 ${className}`}>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            <span
              className={`px-2 py-1 text-xs font-medium rounded-full border ${getStatusColor(selectedTicket.status)}`}
            >
        ...
        <div className='bg-white rounded-lg border p-6'>
          <div className='border-b pb-4 mb-4'>
            <div className='flex items-start justify-between mb-4'>
              ...
              <span
                className={`px-2 py-1 text-xs font-medium rounded ${getPriorityColor(selectedTicket.priority)}`}
              >
                  ...
                  <div className='flex items-start justify-between'>
                    <div className='flex-1 min-w-0'>
                      <div className='flex items-center space-x-2 mb-2'>
                        ...
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded ${getPriorityColor(ticket.priority)}`}
                        >
