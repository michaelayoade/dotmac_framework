...
class StandardExceptions:
    ...
    @staticmethod
    def already_exists(resource: str, identifier: str | None = None) -> HTTPException:
    ...
    @staticmethod
    def internal_error(operation: str, error: str | None = None) -> HTTPException:
    ...
    @staticmethod
    def tenant_error(operation: str, tenant_id: str | None = None) -> HTTPException:
    ...
    @staticmethod
    def config_error(setting: str, message: str | None = None) -> HTTPException:
...
def provisioning_failed(tenant_id: str, reason: str | None = None) -> HTTPException:
...
def coolify_error(operation: str, error: str | None = None) -> HTTPException:
