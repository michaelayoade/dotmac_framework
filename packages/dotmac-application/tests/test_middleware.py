...
class TestMiddlewareComposition:
    ...
    def test_apply_standard_middleware_with_providers(self, mock_providers, test_config):
    ...
    def test_partial_provider_support(self, test_config):
        ...
        applied = apply_standard_middleware(app, config=test_config, providers=providers)
    ...
    def test_deployment_specific_middleware(self, mock_providers):
        ...
        applied = apply_standard_middleware(app, config=tenant_config, providers=mock_providers)
