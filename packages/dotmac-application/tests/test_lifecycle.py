...
class TestLifecycleManagement:
    ...
    def test_lifecycle_manager_initialization(self, lifecycle_manager):
        ...
        assert lifecycle_manager.startup_complete is False
        assert lifecycle_manager.shutdown_complete is False
    ...
    async def test_startup_phase_execution(self, lifecycle_manager):
        ...
        # Mock startup tasks
        with patch.object(
            lifecycle_manager, "_execute_startup_tasks", new_callable=AsyncMock
        ) as mock_startup:
            ...
            assert lifecycle_manager.startup_complete is True
    ...
    async def test_shutdown_phase_execution(self, lifecycle_manager):
        ...
        # Mock shutdown tasks
        with patch.object(
            lifecycle_manager, "_execute_shutdown_tasks", new_callable=AsyncMock
        ) as mock_shutdown:
            ...
            assert lifecycle_manager.shutdown_complete is True
    ...
    async def test_startup_tasks_execution(self):
        ...
        with patch.object(
            lifecycle_manager, "_execute_single_startup_task", new_callable=AsyncMock
        ) as mock_task:
    ...
    async def test_shutdown_tasks_execution(self):
        ...
        with patch.object(
            lifecycle_manager, "_execute_single_shutdown_task", new_callable=AsyncMock
        ) as mock_task:
            mock_task.side_effect = mock_execute_task
    ...
    async def test_lifespan_context_manager(self):
        ...
        with patch.object(
            lifecycle_manager, "startup", new_callable=AsyncMock
        ) as mock_startup_method:
            with patch.object(
                lifecycle_manager, "shutdown", new_callable=AsyncMock
    ...
    def test_deployment_specific_lifecycle_tasks(self):
        ...
        management_context = DeploymentContext(mode=DeploymentMode.MANAGEMENT_PLATFORM)
