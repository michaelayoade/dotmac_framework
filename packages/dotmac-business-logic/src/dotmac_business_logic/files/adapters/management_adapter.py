    ...
    async def generate_tenant_onboarding_package(
        ...
        try:
            ...
            onboarding_data = {
                ...
                "tenant_info": tenant_info.to_dict(),
                "welcome_message": "Welcome to the DotMac Platform! This document contains important information to help you get started.",
                "generated_at": datetime.now(timezone.utc).isoformat(),
                "sections": [],
            }
            ...
            onboarding_data["sections"].append(
                {
                    "type": "paragraph",
                    "content": "Your account has been successfully created with the following details:",
                }
            )
