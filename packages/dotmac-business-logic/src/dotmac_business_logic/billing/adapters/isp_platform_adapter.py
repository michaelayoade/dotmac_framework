...
try:
    ...
    # Import ISP database session factory when available
    from dotmac_isp.core.database import get_async_session as isp_session_factory
    ...
    # Import schema types that will be used for type hints and validation
    ...
    BaseTenantService = object

    # Fallback schema types
    BillingPlanResponse = dict[str, Any]
    InvoiceCreate = dict[str, Any]
    InvoiceUpdate = dict[str, Any]
    ...
    async def create_service_subscription(
        ...
        subscription_data = {
            ...
            "metadata": {
                ...
                "installation_address": service_instance.installation_address,
                **(custom_pricing or {}),
            },
        }
