...
class PublishError(EventBusError):
    ...
    def __init__(self, message: str, event: Optional[Event] = None, cause: Optional[Exception] = None):
...
class ConsumeError(EventBusError):
    ...
    def __init__(self, message: str, topic: Optional[str] = None, cause: Optional[Exception] = None):
        super().__init__(message)
        self.topic = topic
        self.cause = cause
