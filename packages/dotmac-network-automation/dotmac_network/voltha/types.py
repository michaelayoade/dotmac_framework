...
class VOLTHAAlarm:
    ...
    raised_ts: datetime = field(default_factory=lambda: datetime.now(timezone.utc))
...
class VOLTHAResponse:
    ...
    def success_response(
        cls, message: str, data: Any = None, device_id: str = None
    ) -> "VOLTHAResponse":
    ...
    @classmethod
    def error_response(
        cls, message: str, error_code: str, device_id: str = None
    ) -> "VOLTHAResponse":
