...
class DatabasePaginator:
    ...
    def paginate_query(
        ...
        try:
            ...
            raise DatabaseError(f"Pagination failed: {e}")
    ...
    async def async_paginate_query(
        ...
        try:
            ...
            raise DatabaseError(f"Async pagination failed: {e}")
    ...
    def cursor_paginate_query(
        ...
        try:
            ...
            raise DatabaseError(f"Cursor pagination failed: {e}")
    ...
    async def async_cursor_paginate_query(
        ...
        try:
            ...
            raise DatabaseError(f"Async cursor pagination failed: {e}")
...
class PerformancePaginator:
    ...
    def paginate_with_count_estimate(
        ...
        try:
            ...
            raise DatabaseError(f"Performance pagination failed: {e}")
        ...
        try:
            ...
            if page <= deep_threshold:
                ...
                if cursor_item:
                    ...
                    optimized_query = query.filter(cursor_column >= cursor_value).order_by(cursor_column)
            ...
            raise DatabaseError(f"Deep pagination optimization failed: {e}")
...
class PaginationHelper:
    ...
    def encode_cursor(value: Any) -> str:
        ...
        try:
            ...
            raise DatabaseError(f"Failed to encode cursor: {e}")
    ...
    def decode_cursor(cursor: str) -> Any:
        ...
        try:
            ...
            raise DatabaseError(f"Failed to decode cursor: {e}")
    ...
    def create_cursor_from_item(item: Any, field_name: str) -> str:
        ...
        try:
            ...
            raise DatabaseError(f"Failed to create cursor: {e}")
...
class CursorHelper:
    ...
    def validate_cursor_field(model_class: type, field_name: str) -> bool:
        ...
        try:
            ...
            return (
                field.unique if hasattr(field, 'unique') else False or
                field_name in ['id', 'created_at', 'updated_at']  # Common cursor fields
            )
