...
try:
    ...
    def shared_task(bind: bool = False, timezone: Optional[str] = None, **kwargs):
        def decorator(func):
            return func
...
def cleanup_expired_allocations(
    ...
    try:
        from dotmac.database.session import get_database_session
