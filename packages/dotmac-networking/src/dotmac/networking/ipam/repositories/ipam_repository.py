...
class IPAMRepository:
    ...
    def create_network(self, **network_data) -> IPNetwork:
        ...
        try:
            ...
            self.db.rollback()
            raise IPAMError(f"Failed to create network: {e}") from e
    ...
    def get_networks_by_tenant(
        ...
        query = self.db.query(IPNetwork).filter(
            IPNetwork.tenant_id == tenant_id, IPNetwork.is_active is True
        )
    ...
    def update_network(
        ...
        try:
            ...
            self.db.rollback()
            raise IPAMError(f"Failed to update network: {e}") from e
    ...
    def create_allocation(self, **allocation_data) -> IPAllocation:
        ...
        try:
            ...
            self.db.rollback()
            raise IPAMError(f"Failed to create allocation: {e}") from e
    ...
    def update_allocation(
        ...
        try:
            ...
            self.db.rollback()
            raise IPAMError(f"Failed to update allocation: {e}") from e
    ...
    def create_reservation(self, **reservation_data) -> IPReservation:
        ...
        try:
            ...
            self.db.rollback()
            raise IPAMError(f"Failed to create reservation: {e}") from e
    ...
    def update_reservation(
        ...
        try:
            ...
            self.db.rollback()
            raise IPAMError(f"Failed to update reservation: {e}") from e
