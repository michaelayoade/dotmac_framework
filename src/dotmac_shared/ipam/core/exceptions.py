...
class IPAddressConflictError(IPAMError):
    ...
    def __init__(self, ip_address: str, message: str = None):
...
class NetworkNotFoundError(IPAMError):
    ...
    def __init__(self, network_id: str, message: str = None):
...
class InvalidNetworkError(IPAMError):
    ...
    def __init__(self, cidr: str, reason: str = None):
        self.cidr = cidr
        if reason:
...
class AllocationNotFoundError(IPAMError):
    ...
    def __init__(self, allocation_id: str, message: str = None):
...
class ReservationNotFoundError(IPAMError):
    ...
    def __init__(self, reservation_id: str, message: str = None):
...
class NetworkOverlapError(IPAMError):
    ...
    def __init__(self, cidr: str, existing_cidr: str, message: str = None):
        self.cidr = cidr
...
class ExpiredAllocationError(IPAMError):
    ...
    def __init__(self, allocation_id: str, expired_at: str, message: str = None):
        self.allocation_id = allocation_id
...
class TenantIsolationError(IPAMError):
    ...
    def __init__(self, tenant_id: str, resource_id: str, message: str = None):
