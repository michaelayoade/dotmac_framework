...
class ResponseContext:
    ...
    # Cache info
    cache_status: str | None = None  # hit, miss, bypass
...
class ResponseDecorator:
    ...
    def __init__(self, config: ResponseHeaderConfig | None = None):
    ...
    def create_error_response(
        ...
        response = JSONResponse(status_code=status_code, content=error_data)
