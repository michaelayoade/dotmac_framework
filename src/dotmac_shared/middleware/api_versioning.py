...
class APIVersioningMiddleware:
    ...
    def __init__(
        ...
        supported_versions: dict[str, APIVersionInfo] | None = None,
    ):
    ...
    def _find_closest_version(self, requested_version: str) -> str | None:
        """Find closest supported version."""
        # Simple logic - find highest supported version
        supported = [
            v
            for v, info in self.supported_versions.items()
