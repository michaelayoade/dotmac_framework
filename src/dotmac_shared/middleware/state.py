...
class RequestState:
    ...
    api_version_context: Optional[APIVersionContext] = None
...
class RequestStateManager:
    ...
    @staticmethod
    def update_tenant_context(request: Request, 
                            tenant_id: str, 
                            source: str = "unknown",
                            **kwargs):
    ...
    @staticmethod
    def update_user_context(request: Request,
                          user_id: str,
                          **kwargs):
    ...
    @staticmethod
    def update_api_version_context(request: Request,
                                 version: str,
                                 **kwargs):
    ...
    @staticmethod
    def validate_state(request: Request, 
                      require_tenant: bool = False,
                      require_user: bool = False,
                      require_version: bool = False) -> List[str]:
