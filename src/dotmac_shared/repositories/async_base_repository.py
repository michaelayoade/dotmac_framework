...
class AsyncBaseRepository(Generic[ModelType]):
    ...
    def __init__(
        self, db: AsyncSession, model: type[ModelType], tenant_id: str | None = None
    ):
        self.db = db
        self.model = model
    ...
    async def create(
        self, obj_data: dict[str, Any], user_id: str | None = None
    ) -> ModelType:
    ...
    async def update(
        self, id: UUID, obj_data: dict[str, Any], user_id: str | None = None
    ) -> ModelType | None:
        ...
        try:
            ...
            query = query.values(**obj_data).execution_options(
    ...
    async def delete(
        self, id: UUID, soft_delete: bool = True, user_id: str | None = None
    ) -> bool:
        ...
        try:
            ...
            if success:
                self._logger.info(
                    f"Deleted {self.model.__name__} with ID: {id} (soft: {soft_delete})"
                )
    ...
    async def bulk_create(
        self, objects_data: list[dict[str, Any]], user_id: str | None = None
    ) -> list[ModelType]:
        ...
        try:
            ...
            self._logger.info(
                f"Bulk created {len(db_objects)} {self.model.__name__} entities"
            )
            return db_objects
    ...
    async def exists(self, id: UUID) -> bool:
        ...
        try:
            ...
            self._logger.exception(
                f"Error checking existence of {self.model.__name__} {id}"
            )
...
class AsyncTenantRepository(AsyncBaseRepository[ModelType]):
    ...
    async def get_tenant_stats(self) -> dict[str, Any]:
        ...
        try:
            ...
            self._logger.exception(
                f"Error getting tenant stats for {self.model.__name__}"
            )
