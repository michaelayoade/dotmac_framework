...
class DashboardManager:
    ...
    def _prepare_template_variables(
        ...
        variables = {
            "platform_type": platform_type,
            "service_name": f"dotmac-{platform_type}" if platform_type == "management" else f"isp-framework",
    ...
    async def _process_alert_rules(
        ...
        try:
            ...
            if prometheus_alerts_file.exists():
                with open(prometheus_alerts_file, 'r') as f:
    ...
    async def export_dashboard_configs(
        ...
        try:
            ...
            for i, alert_set in enumerate(results["alerts"]):
