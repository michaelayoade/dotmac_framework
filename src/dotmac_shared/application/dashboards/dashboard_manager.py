...
class DashboardManager:
    ...
    async def provision_dashboards_for_platform(
        self, platform_type: str, tenant_id: Optional[str] = None, custom_variables: Optional[dict[str, Any]] = None
    ) -> dict[str, Any]:
        """
    ...
    def _prepare_template_variables(
        self, platform_type: str, tenant_id: Optional[str], custom_variables: Optional[dict[str, Any]]
    ) -> dict[str, Any]:
    ...
    async def _process_alert_rules(self, platform_type: str, variables: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        try:
            ...
            if prometheus_alerts_file.exists():
                ...
                results.append({"type": "prometheus", "rules": processed_prometheus, "provisioning_status": "ready"})
            ...
            if signoz_alerts_file.exists():
                ...
                results.append({"type": "signoz", "alerts": processed_signoz, "provisioning_status": "ready"})
...
async def provision_platform_dashboards(
    platform_type: str, tenant_id: Optional[str] = None, custom_variables: Optional[dict[str, Any]] = None
) -> dict[str, Any]:
    """
