...
pass  # previously 'else:' for PYDANTIC_AVAILABLE; removed stub schemas
...
class SLAPolicy(TenantModel, StatusMixin, AuditMixin):
    ...
    # SLA thresholds
    availability_threshold = Column(Float, default=99.9, nullable=False)  # percentage
    latency_threshold_ms = Column(Integer, default=100, nullable=False)  # milliseconds
