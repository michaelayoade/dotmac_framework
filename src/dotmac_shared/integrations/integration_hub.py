...
class IntegrationHubService:
    ...
    @standard_exception_handler
    async def update(
        self, integration_id: UUID, data: IntegrationUpdateSchema, user_id: UUID
    ...
    @standard_exception_handler
    async def test_connection(self, integration_name: str) -> dict[str, Any]:
    ...
    @standard_exception_handler
    async def sync_integration(self, integration_name: str) -> dict[str, Any]:
