...
class StandardExceptions:
    ...
    @staticmethod
    def internal_error(operation: str, error: Optional[str] = None) -> HTTPException:
    ...
    @staticmethod
    def tenant_error(operation: str, tenant_id: Optional[str] = None) -> HTTPException:
    ...
    @staticmethod
    def config_error(setting: str, message: Optional[str] = None) -> HTTPException:
...
def provisioning_failed(tenant_id: str, reason: Optional[str] = None) -> HTTPException:
...
def coolify_error(operation: str, error: Optional[str] = None) -> HTTPException:
