...
from .exceptions import PluginDependencyError, PluginError, PluginNotFoundError
        ...
        async with self._lock.reader:
            ...
            for search_domain in domains_to_search:
                ...
                for plugin in self._plugins[search_domain].values():
                    ...
                    # Categories filter
                    if categories and not categories.issubset(
                    ...
                    if name_pattern:
                        ...
                        if not fnmatch.fnmatch(
                            plugin.name.lower(), name_pattern.lower()
                        ):
                            continue
