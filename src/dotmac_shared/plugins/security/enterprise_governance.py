...
from dotmac_shared.core.exceptions import BusinessRuleError, ValidationError
...
from ..core.exceptions import PluginGovernanceError
from .access_control_system import PluginAccessControlSystem
...
class EnterprisePluginGovernanceSystem:
    ...
    def __init__(
        self,
        access_control_system: Optional[PluginAccessControlSystem] = None,
    ...
    def _initialize_default_policies(self) -> None:
        ...
        default_policies = [
            ...
            GovernancePolicy(
                ...
                rules=[
                    {
                        "condition": "security_scan_status",
                        "operator": "equals",
                        "value": "passed"
                    }
                ],
            ...
            GovernancePolicy(
                ...
                rules=[
                    {
                        "condition": "audit_logging_implemented",
                        "operator": "equals",
                        "value": True
                    }
                ],
    ...
    async def generate_compliance_report(
        ...
        # Get unique plugins
        plugin_ids = set(v.plugin_id for v in period_violations)
