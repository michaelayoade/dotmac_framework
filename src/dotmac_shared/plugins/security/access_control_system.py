...
from ..core.exceptions import PluginPermissionError, PluginAccessDeniedError
...
class PluginAccessControlSystem:
    """
    ...
    def _initialize_system_roles(self) -> None:
        ...
        system_roles = [
            ...
            Role(
                ...
                permissions=["system_manage", "plugin_manage", "api_read", "api_write", "data_read", "data_write", "system_monitor"],
                system_role=True,
                tenant_scoped=False
            ),
        ]
    ...
    def _cache_decision(self, cache_key: str, decision: AccessDecision) -> None:
        ...
        if len(self._permission_cache) >= self.max_cache_entries:
            ...
            oldest_key = min(
                ...
                key=lambda k: self._permission_cache[k].evaluated_at
            )
    ...
    def get_subject_permissions(self, subject_id: str) -> List[AccessControlEntry]:
        ...
        return [
            ace for ace in self._access_control_entries.values()
...
) -> PluginAccessControlSystem:
    """Create plugin access control system."""
    return PluginAccessControlSystem(audit_monitor)
