...
from ..core.exceptions import PluginCertificationError
...
class PluginCertificationSystem:
        ...
        return {
            "security": [
                ReviewCriteria(
                    ...
                    "security",
                    weight=2.0,
                    required_for_levels=[CertificationLevel.STANDARD, CertificationLevel.PREMIUM, CertificationLevel.ENTERPRISE],
    ...
    async def _check_certification_eligibility(self, submission_id: str) -> None:
        ...
        submission_reviews = [
            review for review in self._active_reviews.values()
    ...
    def _check_compliance_validation(self, reviews: List[CodeReview]) -> bool:
        ...
        return any(
            review.reviewer_level == ReviewerLevel.COMPLIANCE_OFFICER
            for review in reviews
        )
