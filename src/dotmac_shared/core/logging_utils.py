...
class LoggingPatterns:
    ...
    @staticmethod
    def log_operation_success(logger, operation: str, entity_id: str = None, correlation_id: str = None, **kwargs):
    ...
    @staticmethod
    def log_operation_error(logger, operation: str, error: Exception, entity_id: str = None, correlation_id: str = None, **kwargs):
    ...
    @staticmethod
    def log_validation_error(logger, field: str, error: str, entity_id: str = None, **kwargs):
    ...
    @staticmethod
    def log_external_api_call(logger, service: str, operation: str, status_code: int = None, duration: float = None, **kwargs):
    ...
    @staticmethod
    def log_tenant_action(logger, action: str, tenant_id: str, user_id: str = None, **kwargs):
    ...
    @staticmethod
    def log_security_event(logger, event: str, user_id: str = None, ip_address: str = None, **kwargs):
