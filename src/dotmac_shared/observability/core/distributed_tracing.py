...
Based on the ISP framework implementation but enhanced for shared service usage.
"""
...
class TraceContext:
    ...
    causation_id: Optional[str] = None  # For event causation tracking
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TraceContext":
        ...
        if data.get("end_time"):
            context.end_time = datetime.fromisoformat(
...
class DistributedTracer:
    ...
    def finish_span(
        ...
        """Finish a span."""
        context.end_time = end_time or datetime.now(timezone.utc)
    ...
    def get_completed_spans(self, trace_id: Optional[str] = None) -> List[TraceContext]:
...
class TraceAnalyzer:
    ...
    def _get_span_depth(
        self, span: TraceContext, span_map: Dict[str, TraceContext], visited: Set[str]
    ) -> int:
