...
class TestEnvironmentSecurityValidator:
    ...
    async def test_comprehensive_security_validation(self):
        ...
        mock_secrets_manager.validate_environment_compliance = AsyncMock(return_value={
            "compliant": True,
            "violations": [],
