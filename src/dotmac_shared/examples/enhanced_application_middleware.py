...
from dotmac_shared.application.config import DeploymentContext, DeploymentMode, PlatformConfig
from dotmac_shared.application.middleware import StandardMiddlewareStack
from dotmac_shared.middleware.api_versioning import APIVersionInfo, APIVersioningMiddleware, VersionStatus
from dotmac_shared.middleware.background_operations import BackgroundOperationsMiddleware
...
def create_enhanced_app() -> FastAPI:
    ...
    # Create FastAPI app
    app = FastAPI(
        title="DotMac Enhanced Application", version="1.0.0", description="Example application with enhanced middleware"
    )
