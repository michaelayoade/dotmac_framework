        ...
        async def async_wrapper(*args, **kwargs):
            ...
            if not flag_manager:
                ...
                if fallback_enabled:
                    ...
                    if on_disabled:
                        return await on_disabled(*args, **kwargs) if asyncio.iscoroutinefunction(on_disabled) else on_disabled(*args, **kwargs)
                    return None
    ...
    def decorator(func):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                raise HTTPException(status_code=503, detail="Feature flag evaluation failed")
    ...
    def decorator(func):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            if not flag_manager:
                ...
                return await variant_func(*args, **kwargs) if asyncio.iscoroutinefunction(variant_func) else variant_func(*args, **kwargs)
