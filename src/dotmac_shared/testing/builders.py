...
from .factories import BaseFactory, FactoryRegistry, RelationshipDefinition
...
class ScenarioBuilder(BaseBuilder):
    ...
    def customer_onboarding_scenario(
        self,
        tenant_id: str,
        service_type: str = "basic_internet"
    ) -> 'ScenarioBuilder':
        """Pre-built customer onboarding scenario."""
        return (self
            .set_variable("tenant_id", tenant_id)
    ...
    def service_provisioning_scenario(
        ...
        return (self
            .set_variable("customer_id", customer_id)
            .add_step(
                "service_order",
