...
class ISPServiceClient(ServiceClient):
    ...
    async def suspend_service(self, subscription_id: str, suspension_data: Dict[str, Any], journey_id: str) -> Dict[str, Any]:
        """Suspend a service"""
        response = await self.post(
    ...
    async def restore_service(self, subscription_id: str, restoration_data: Dict[str, Any], journey_id: str) -> Dict[str, Any]:
    ...
    async def reconfigure_service(self, subscription_id: str, config_data: Dict[str, Any], journey_id: str) -> Dict[str, Any]:
...
class ManagementServiceClient(ServiceClient):
    ...
    async def approve_upgrade_request(self, request_id: str, approval_data: Dict[str, Any], journey_id: str) -> Dict[str, Any]:
...
class BillingServiceClient(ServiceClient):
    ...
    async def simulate_payment_failure(self, account_id: str, failure_data: Dict[str, Any], journey_id: str) -> Dict[str, Any]:
    ...
    async def process_plan_change(self, account_id: str, change_data: Dict[str, Any], journey_id: str) -> Dict[str, Any]:
...
class NotificationServiceClient(ServiceClient):
    ...
    async def get_notifications_by_customer(self, customer_id: str, notification_type: Optional[str] = None) -> List[Dict[str, Any]]:
