...
from .factories import FactoryRegistry, BaseFactory, FactoryMetadata, cleanup_all_factories
from .generators import DataGenerator, DataType, GenerationConfig
...
class TestPytestFixtureIntegration:
    ...
    def test_complete_scenario_fixture(self, complete_customer_scenario):
        ...
        expected_entities = [
            ...
            'billing_account', 'invoice', 'router'
        ]
...
class TestPerformanceAndReliability:
    ...
    def test_cleanup_reliability(self, factory_registry):
        ...
        customer_factory.tenant_id = tenant.id
        customers = customer_factory.create_batch(count=10)
...
def test_complete_system_integration():
    ...
    from .entity_factories import (
        TenantFactory, UserFactory, CustomerFactory, 
        ServiceFactory, BillingFactory
    )
