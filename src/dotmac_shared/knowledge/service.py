...
from sqlalchemy import and_, asc, delete, desc, func, or_, select, update, text
from sqlalchemy.ext.asyncio import AsyncSession
from sqlalchemy.orm import selectinload

from .models import (
    ArticleAnalytics, ArticleComment, ArticleCreate, ArticleResponse,
    ArticleSearchParams, ArticleStatus, ArticleType, ArticleUpdate,
    CommentCreate, CommentResponse, KnowledgeArticle, PortalSettingsUpdate,
    PortalSettingsResponse, CustomerPortalSettings
)
            ...
            if search_params.tags:
                ...
                for tag in search_params.tags:
                    tag_conditions.append(
                        func.json_array_elements_text(KnowledgeArticle.tags).op('@>')([tag])
                    )
