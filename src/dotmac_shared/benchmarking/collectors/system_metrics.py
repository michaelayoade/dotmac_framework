        ...
        try:
            with process.oneshot():
                ...
                return ProcessMetrics(
                    ...
                    io_read_chars=io_counters.read_chars if io_counters and hasattr(io_counters, 'read_chars') else None,
                    io_write_chars=io_counters.write_chars if io_counters and hasattr(io_counters, 'write_chars') else None
                )
            ...
            if format == "json":
                ...
                with open(filepath, 'w', newline='') as f:
                    ...
                    writer.writerow([
                        ...
                        'disk_percent', 'load_average_1m', 'network_bytes_sent',
                        'network_bytes_recv', 'process_count', 'active_connections'
                    ])
