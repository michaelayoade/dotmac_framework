...
from .engine import TaskResult, TaskStatus, TaskError
    ...
    async def send_notification(self, request: NotificationRequest) -> bool:
        ...
        try:
            ...
            async with httpx.AsyncClient(verify=self.verify_ssl) as client:
                ...
                logger.info(f"Webhook notification sent", extra={
                    'notification_id': request.notification_id,
...
class EmailProvider(NotificationChannelProvider):
    ...
    async def send_notification(self, request: NotificationRequest) -> bool:
        ...
        try:
            ...
            logger.info(f"Email notification sent", extra={
                'notification_id': request.notification_id,
...
class TaskNotificationService:
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info(f"Notification service initialized", extra={
            ...
            raise TaskError(f"Notification service initialization failed: {e}")
    ...
    async def start(self):
        ...
        logger.info(f"Notification service started", extra={'service_id': self.service_id})
    ...
    async def send_notification(
        ...
        try:
            ...
            logger.info(f"Notification queued", extra={
                'notification_id': notification_id,
            ...
            while self._is_running:
                try:
                    ...
                    request = await asyncio.wait_for(
                        self._pending_notifications.get(), 
                        timeout=5.0
                    )
    ...
    async def _process_notification(self, request: NotificationRequest):
        ...
        try:
            ...
            if success:
                ...
                logger.info(f"Notification sent successfully", extra={
                    'notification_id': request.notification_id,
    ...
    async def _handle_notification_failure(self, request: NotificationRequest):
        ...
        if request.attempts >= request.max_retries:
            ...
            logger.error(f"Notification failed permanently", extra={
                'notification_id': request.notification_id,
            ...
            logger.info(f"Notification scheduled for retry", extra={
                'notification_id': request.notification_id,
