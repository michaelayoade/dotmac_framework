...
if SQLALCHEMY_AVAILABLE:
    ...
    class Lead(TenantModel, StatusMixin, AuditMixin, ContactMixin, AddressMixin):
        ...
        activities = relationship(
            "SalesActivity",
            foreign_keys="[SalesActivity.lead_id]",
            back_populates="lead",
        )
    ...
    class Opportunity(TenantModel, StatusMixin, AuditMixin, AddressMixin):
        ...
        # Forecasting
        forecast_category = Column(String(50), nullable=True)
        ...
        __table_args__ = (
            Index(
                "ix_opportunities_stage_status",
                "opportunity_stage",
                "opportunity_status",
            ),
            Index(
                "ix_opportunities_owner_close_date",
                "sales_owner",
                "expected_close_date",
            ),
    ...
    class SalesActivity(TenantModel, AuditMixin):
        ...
        buying_interest = Column(Integer, nullable=True)
    ...
    class SalesForecast(TenantModel, AuditMixin):
        ...
        # Forecast period
        forecast_period = Column(String(50), nullable=False, index=True)
