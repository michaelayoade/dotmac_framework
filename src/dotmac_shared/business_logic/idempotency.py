...
from .exceptions import IdempotencyError, ErrorContext

# Type variable for operation results
T = TypeVar('T')
...
class IdempotencyManager:
    ...
    def _get_operation_record(
        ...
        return db.query(IdempotentOperationRecord).filter(
            IdempotentOperationRecord.idempotency_key == idempotency_key
        ).first()
