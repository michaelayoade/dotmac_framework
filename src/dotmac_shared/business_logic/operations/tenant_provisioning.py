...
from ..exceptions import ProvisioningError, ErrorContext
...
class ConfigureDatabaseStep(SagaStep):
    ...
    async def execute(self, context: SagaContext) -> Dict[str, Any]:
        ...
        database_config = {
            ...
            "tables_created": [
                "users", "customers", "services", "billing"
            ],
    ...
    async def execute(self, context: SagaContext) -> Dict[str, Any]:
        ...
        defaults_config = {
            ...
            "default_settings": {
                ...
                "features_enabled": [
                    "dashboard", "user_management", "basic_reports"
...
class TenantProvisioningOperation(IdempotentOperation[Dict[str, Any]]):
    ...
    async def execute(
        ...
        from ..sagas import SagaCoordinator, SagaContext
        ...
        saga_definition = TenantProvisioningSaga.create_definition()
