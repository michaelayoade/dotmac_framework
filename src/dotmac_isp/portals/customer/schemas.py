...
# from dotmac_shared.ticketing import TicketResponse, CommentCreate
...
# Ticket schemas moved to dotmac_shared.ticketing package
# Use: from dotmac_shared.ticketing import TicketCreate, CommentCreate
