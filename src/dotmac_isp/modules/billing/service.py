...
from .models import Invoice, Payment, BillingCustomer, Subscription
    ...
    async def upload_invoice_attachment(
        ...
        try:
            ...
            file_url = await storage_service.upload_file(
                file=file,
                folder=f"invoices/{invoice.invoice_number}/attachments"
            )
    ...
    async def create(self, data: Dict[str, Any], user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if data.get("invoice_id"):
                invoice = self.invoice_repo.get_by_id_or_raise(UUID(data["invoice_id"]))
