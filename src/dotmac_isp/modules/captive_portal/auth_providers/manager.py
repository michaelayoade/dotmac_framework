...
class AuthenticationManager:
    ...
    def register_provider(
        ...
        try:
            ...
            raise ServiceError(f"Failed to register authentication provider: {str(e)}")
    ...
    async def prepare_authentication(
        ...
        try:
            ...
            raise ServiceError(f"Failed to prepare authentication: {str(e)}")
    ...
    def update_provider_config(
        ...
        try:
            ...
            raise ServiceError(f"Failed to update provider configuration: {str(e)}")
