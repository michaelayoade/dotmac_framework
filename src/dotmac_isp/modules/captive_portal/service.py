...
class CaptivePortalService(BaseTenantService):
    ...
    async def create_portal(self, portal_data: CaptivePortalConfigCreate) -> CaptivePortalConfigResponse:
        ...
        try:
            ...
            raise ServiceError(f"Failed to create portal: {str(e)}")
    ...
    async def get_portal(self, portal_id: str) -> Optional[CaptivePortalConfigResponse]:
        ...
        try:
            ...
            raise ServiceError(f"Failed to retrieve portal: {str(e)}")
    ...
    async def update_portal(
        ...
        try:
            ...
            raise ServiceError(f"Failed to update portal: {str(e)}")
    ...
    async def delete_portal(self, portal_id: str) -> bool:
        ...
        try:
            ...
            raise ServiceError(f"Failed to delete portal: {str(e)}")
    ...
    async def _authenticate_email(
        ...
        try:
            ...
            raise AuthenticationError(f"Email authentication failed: {str(e)}")
    ...
    async def _authenticate_social(
        ...
        try:
            ...
            session = await self._create_session(
                ...
                client_mac=auth_request.client_mac,
                user_agent=auth_request.user_agent,
                auth_data={'provider': auth_request.provider, 'code': auth_request.code}
            )
    ...
    async def _authenticate_voucher(
        ...
        try:
            ...
            raise AuthenticationError(f"Voucher authentication failed: {str(e)}")
    ...
    async def _authenticate_radius(
        ...
        try:
            ...
            raise AuthenticationError(f"RADIUS authentication failed: {str(e)}")
    ...
    async def validate_session(self, session_token: str) -> Optional[SessionResponse]:
        ...
        try:
            ...
            raise ServiceError(f"Failed to validate session: {str(e)}")
    ...
    async def terminate_session(
        ...
        try:
            ...
            raise ServiceError(f"Failed to terminate session: {str(e)}")
    ...
    async def update_session_usage(
        ...
        try:
            ...
            raise ServiceError(f"Failed to update session usage: {str(e)}")
    ...
    async def create_vouchers(self, voucher_request: VoucherCreateRequest) -> List[VoucherResponse]:
        ...
        try:
            ...
            vouchers = []
            for i in range(voucher_request.quantity):
            ...
            raise ServiceError(f"Failed to create vouchers: {str(e)}")
    ...
    async def redeem_voucher(self, voucher_code: str, portal_id: str, user_id: str) -> bool:
        ...
        try:
            ...
            raise ServiceError(f"Failed to redeem voucher: {str(e)}")
    ...
    async def get_portal_stats(
        ...
        try:
            ...
            raise ServiceError(f"Failed to get portal stats: {str(e)}")
