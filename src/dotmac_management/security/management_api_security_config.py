...
from dotmac_shared.auth.middleware.rate_limiting import RateLimitRule, RateLimitType
...
class ManagementAPISecurityConfig:
    ...
    def _setup_security_policies(self) -> None:
        ...
        self.security_policies = {
            ...
            EndpointSensitivity.CRITICAL: SecurityPolicy(
                ...
                time_window_seconds=60,
                rate_limit_type=RateLimitType.IP_BASED,  # IP-based for critical operations
    ...
    def get_rate_limit_rules(self) -> List[RateLimitRule]:
        ...
        rules.append(RateLimitRule(
            ...
            endpoints=[
                "/api/v1/admin/remove-bootstrap-credentials"
            ],
            methods=["POST"]
        ))
