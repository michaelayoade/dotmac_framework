...
from dotmac_shared.api.dependencies import get_current_user, get_current_tenant_id
...
from ..schemas.auth_schemas import (
    ...
    PasswordChangeRequestSchema, APIKeyCreateRequestSchema, APIKeyResponseSchema,
    AuthEventSchema, SessionResponseSchema
)
...
def create_auth_router() -> APIRouter:
    ...
    @router.post("/api-keys", response_model=APIKeyResponseSchema)
    @standard_exception_handler
...
def create_rbac_router() -> APIRouter:
    ...
    from ..schemas.rbac_schemas import (
        RoleCreateSchema, RoleUpdateSchema, RoleResponseSchema, RoleSearchSchema,
        PermissionCreateSchema, PermissionResponseSchema, PermissionSearchSchema,
        UserRoleCreateSchema, BulkRoleAssignmentSchema, PermissionCheckRequestSchema,
        PermissionCheckResponseSchema, UserPermissionSummarySchema
    )
