...
from ..schemas.user_schemas import UserStatus, UserType, MFAMethod
...
class UserModel(BaseModel):
    ...
    terms_accepted_at = Column(
        DateTime,
        nullable=True,
        comment="Terms acceptance timestamp"
    )
    ...
    def has_role(self, role_name: str) -> bool:
        ...
        for user_role in self.roles:
            if (user_role.role and 
                user_role.role.name == role_name and 
                user_role.is_active):
                return True
        return False
...
class UserProfileModel(BaseModel):
    ...
    website = Column(
        String(500),
        nullable=True,
        comment="Personal or professional website"
    )
    linkedin_url = Column(
        String(500),
        nullable=True,
    ...
    skills = Column(
        ...
        nullable=True,
        default=list,
        comment="User skills list"
    )
    interests = Column(
        JSON,
        nullable=True,
        default=list,
        comment="User interests list"
    )
...
class UserContactInfoModel(BaseModel):
    ...
    billing_postal_code = Column(
        String(20),
        nullable=True,
        comment="Billing postal/ZIP code"
    )
...
class UserPreferencesModel(BaseModel):
    ...
    dashboard_layout = Column(
        ...
        nullable=True,
        default=dict,
        comment="Dashboard layout preferences"
    )
    custom_preferences = Column(
        JSON,
        nullable=True,
        default=dict,
        comment="Custom user preferences"
    )
