...
from ..models.rbac_models import RoleModel, PermissionModel, UserRoleModel, RolePermissionModel
...
from ..schemas.rbac_schemas import (
    ...
    UserRoleCreateSchema, BulkRoleAssignmentSchema, BulkPermissionAssignmentSchema,
    PermissionCheckRequestSchema, PermissionCheckResponseSchema,
    UserPermissionSummarySchema, RoleDetailResponseSchema
)
...
class RBACService(BaseService):
    ...
    @standard_exception_handler
    async def search_permissions(self, search_params: PermissionSearchSchema) -> Tuple[List[PermissionResponseSchema], int]:
    ...
    async def bulk_assign_permissions(
        self,
        request: BulkPermissionAssignmentSchema,
        granted_by: Optional[UUID] = None
    ...
    async def assign_role_to_user(
        ...
        user_role = await self.user_role_repo.assign_role_to_user(
            user_id=user_id,
            role_id=role_id,
