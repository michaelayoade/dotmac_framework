...
def create_simple_app() -> FastAPI:
    ...
    async def upgrade_tenant_license(tenant_id: str, new_plan: str):
        ...
        return {
            ...
            "new_plan": new_plan,
            "status": "upgraded",
            "activated_features": ["crm", "projects"]
            if new_plan == "professional"
            else ["crm", "projects", "fieldops", "analytics"],
        }
    ...
    async def monitoring_overview():
        ...
        return {
            ...
            "total_partners": 1,
            "resource_utilization": {"cpu": "45%", "memory": "62%", "storage": "38%"},
        }
...
if __name__ == "__main__":
    ...
    uvicorn.run("main_simple:app", host=host, port=port, reload=True, log_level="info")
