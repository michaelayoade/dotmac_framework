...
# Test database URLs
TEST_MANAGEMENT_DB = os.getenv("TEST_MANAGEMENT_DB", "postgresql://test_user:test_pass@localhost:5433/test_management")
TEST_TENANT_A_DB = os.getenv("TEST_TENANT_A_DB", "postgresql://test_user:test_pass@localhost:5434/test_tenant_a")
TEST_TENANT_B_DB = os.getenv("TEST_TENANT_B_DB", "postgresql://test_user:test_pass@localhost:5435/test_tenant_b")
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", 
        "tenant_provisioning: marks tests as tenant provisioning tests"
    )
    config.addinivalue_line(
        "markers", 
        "container_lifecycle: marks tests as container lifecycle tests"
    )
    config.addinivalue_line(
        "markers",
        "tenant_isolation: marks tests as multi-tenant isolation tests"
    )
    config.addinivalue_line(
        "markers",
