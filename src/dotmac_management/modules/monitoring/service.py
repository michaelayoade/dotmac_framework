...
class ServiceComponentService(BaseService[ServiceComponent]):
    ...
    async def update_component(self, component_id: UUID, data: ServiceComponentUpdate, user_id: UUID) -> ServiceComponentResponse:
...
class PerformanceMetricService(BaseService[PerformanceMetric]):
    ...
    async def create_performance_metric(self, data: PerformanceMetricCreate, user_id: UUID) -> PerformanceMetricResponse:
...
class MonitoringAlertService(BaseService[MonitoringAlert]):
    ...
    async def perform_alert_action(self, alert_id: UUID, action_request: AlertActionRequest, user_id: UUID) -> Dict[str, Any]:
