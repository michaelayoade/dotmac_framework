...
from .base import PluginType, PluginError
...
class PluginConfigManager:
    ...
    async def _create_plugin_config(self, data: Dict[str, Any], source: str):
        ...
        try:
            ...
            logger.error(f"Failed to process plugin configuration in {source}: {e}")
    ...
    async def add_runtime_config(self, plugin_config: PluginConfig) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to add runtime plugin configuration: {e}")
            return False
    ...
    async def update_plugin_config(self, plugin_name: str, config_updates: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to update plugin configuration {plugin_name}: {e}")
            return False
    ...
    async def remove_plugin_config(self, plugin_name: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to remove plugin configuration {plugin_name}: {e}")
            return False
    ...
    def export_configurations(self) -> Dict[str, Any]:
        ...
        return {
            "plugins": [
                asdict(config) for config in self.configs.values()
            ]
        }
    
    @standard_exception_handler
    async def save_configurations(self, file_path: str = None) -> bool:
