...
from .base import PluginType, PluginStatus, PluginError
...
class InfrastructurePluginManager:
    ...
    async def register_deployment_provider(
        self, 
        provider_name: str, 
        plugin: DeploymentProviderPlugin
    ) -> bool:
    ...
    def get_deployment_provider(self, provider_name: str = None) -> Optional[DeploymentProviderPlugin]:
    ...
    def get_dns_provider(self, provider_name: str = None) -> Optional[DNSProviderPlugin]:
    ...
    @asynccontextmanager
    async def get_provider_context(self, provider_type: str, provider_name: str = None):
        """
