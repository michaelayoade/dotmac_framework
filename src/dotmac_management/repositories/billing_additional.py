...
from ..models.billing import Invoice, Payment, PricingPlan, Subscription, UsageRecord
...
class SubscriptionRepository(BaseRepository[Subscription]):
    ...
    async def count_active_subscriptions(self, tenant_id: Optional[UUID] = None) -> int:
...
class UsageRecordRepository(BaseRepository[UsageRecord]):
    ...
    async def get_period_usage(
        self, subscription_id: UUID, metric_name: str, start_date: date, end_date: date
    ) -> Decimal:
    ...
    async def get_period_usage_detailed(
