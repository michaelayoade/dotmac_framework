...
class CoolifyDeploymentPlugin(DeploymentProviderPlugin):
    ...
    def meta(self) -> PluginMeta:
        return PluginMeta(
            ...
            configuration_schema={
                "type": "object",
                "properties": {
                    "base_url": {"type": "string", "description": "Coolify API base URL"},
                    "api_token": {"type": "string", "description": "Coolify API token"},
                    "project_id": {"type": "string", "description": "Default project ID"},
                    "server_id": {"type": "string", "description": "Default server ID", "default": "0"},
                },
    ...
    async def _deploy_application(self, app_id: str) -> dict[str, Any]:
        ...
        return {"deployment_id": result.get("deployment_uuid", app_id), "status": "deploying", "app_id": app_id}
