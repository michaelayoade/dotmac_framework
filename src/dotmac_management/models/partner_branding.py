...
class BrandConfigBase(BaseModel):
    ...
    @field_validator('logo_url', 'logo_dark_url', 'favicon_url', 'support_url', 
    ...
    def validate_url_fields(cls, v: Optional[str], info) -> Optional[str]:
        ...
        try:
            ...
            raise ValueError(f'{info.field_name} must be a valid URL: {str(e)}')
...
class BrandConfigUpdate(BaseModel):
    ...
    validate_url_fields = field_validator('logo_url', 'logo_dark_url', 'favicon_url', 'support_url', 
                                         'privacy_policy_url', 'terms_of_service_url', 'website_url',
                                         'facebook_url', 'twitter_url', 'linkedin_url')(BrandConfigBase.validate_url_fields.__func__)
    validate_hex_colors = field_validator('primary_color', 'secondary_color', 'accent_color', 
                                         'background_color', 'text_color')(BrandConfigBase.validate_hex_colors.__func__)
    ...
    validate_company_legal_name = field_validator('company_legal_name')(BrandConfigBase.validate_company_legal_name.__func__)
