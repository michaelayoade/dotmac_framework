...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers",
        "functional: Functional tests that test end-to-end business functionality"
    )
    config.addinivalue_line(
        "markers",
    ...
    config.addinivalue_line(
        "markers",
        "startup_critical: Tests for critical startup functionality"
    )
    config.addinivalue_line(
        "markers",
        "order: Tests that require specific execution order"
    )
