...
class ResellerService(BaseManagementService):
    ...
    async def update_reseller_status(
        ...
        if notes:
            reseller.notes = f"{reseller.notes}\n{datetime.utcnow().isoformat()}: {notes}" if reseller.notes else notes
    ...
    async def upgrade_reseller_tier(
        ...
        reseller.tier_upgrade_date = datetime.utcnow()
        reseller.updated_by = updated_by
        reseller.updated_at = datetime.utcnow()
    ...
    async def update_opportunity_stage(
        ...
        if notes:
            opportunity.notes = f"{opportunity.notes}\n{datetime.utcnow().isoformat()}: {notes}" if opportunity.notes else notes
