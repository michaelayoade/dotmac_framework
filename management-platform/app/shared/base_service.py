...
class BaseManagementService(
    ...
    async def get_by_id(self, entity_id: UUID, user_id: Optional[str] = None) -> Optional[ModelType]:
        ...
        try:
            ...
            raise ServiceError(f"Failed to get {self.model_class.__name__} by ID: {str(e)}")
    ...
    async def list(
        ...
        try:
            ...
            raise ServiceError(f"Failed to list {self.model_class.__name__}s: {str(e)}")
    ...
    async def count(
        ...
        try:
            ...
            raise ServiceError(f"Failed to count {self.model_class.__name__}s: {str(e)}")
    ...
    async def exists(self, field_name: str, value: Any, exclude_id: Optional[UUID] = None) -> bool:
        ...
        try:
            ...
            raise ServiceError(f"Failed to check {self.model_class.__name__} existence: {str(e)}")