"""
CSRF Middleware Integration for Management Platform
...
def init_csrf_protection(app: FastAPI) -> CSRFProtection:
    """
    Initialize CSRF protection for the management platform
    """
    ...
    # Create CSRF protection with management platform specific config
