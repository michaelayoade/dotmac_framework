...
logger.info("\n🔧 Testing Services Enums...")
    ...
    try:
        from dotmac_isp.modules.services.models import (
            ServiceType, ServiceStatus, ProvisioningStatus, BandwidthUnit
        )
        
        # Test ServiceType enum
        assert ServiceType.INTERNET.value == "internet"
        assert ServiceType.PHONE.value == "phone"
        assert ServiceType.TV.value == "tv"
        assert ServiceType.BUNDLE.value == "bundle"
        assert ServiceType.HOSTING.value == "hosting"
        assert ServiceType.CLOUD.value == "cloud"
        assert ServiceType.MANAGED_SERVICES.value == "managed_services"
        ...
        assert ProvisioningStatus.CANCELLED.value == "cancelled"
        assert len(ProvisioningStatus) == 5
        
        # Test BandwidthUnit enum
        assert BandwidthUnit.KBPS.value == "kbps"
        assert BandwidthUnit.MBPS.value == "mbps"
...
logger.info("\n📋 Testing Service Plan Model Logic...")
    ...
    try:
        ...
        from dotmac_isp.modules.services.models import ServiceType, BandwidthUnit
        ...
        class MockServicePlan:
            ...
            def __init__(self):
                ...
                self.service_type = ServiceType.INTERNET
                ...
                self.bandwidth_unit = BandwidthUnit.MBPS
            ...
            def get_speed_display(self):
                ...
                unit = self.bandwidth_unit.value.upper()
...
logger.info("\n🔗 Testing Service Instance Model Logic...")
    ...
    try:
        ...
        from dotmac_isp.modules.services.models import ServiceStatus
        ...
        class MockServiceInstance:
            ...
            def is_suspended(self):
                ...
                return self.status == ServiceStatus.SUSPENDED
...
logger.info("\n⚙️ Testing Provisioning Task Model Logic...")
    ...
    try:
        ...
        from dotmac_isp.modules.services.models import ProvisioningStatus
        ...
        class MockProvisioningTask:
            ...
            def start_task(self):
                ...
                if self.status == ProvisioningStatus.PENDING:
            ...
            def complete_task(self, result_data=None):
                ...
                if self.status == ProvisioningStatus.IN_PROGRESS:
...
logger.info("\n📊 Testing Service Usage Model Logic...")
    ...
    try:
        ...
        class MockServiceUsage:
            ...
            def is_heavy_usage_day(self, threshold_gb=50):
