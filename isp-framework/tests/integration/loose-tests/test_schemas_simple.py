...
logger.info("Testing PaginationParams.offset property...")
...
logger.info(f"  ✅ Page {page}, Size {size} -> Offset {offset}")
    
logger.info("  ✅ PaginationParams.offset property tests passed")

def test_paginated_response_create():
    """Test PaginatedResponse.create method - covers lines 101-102."""
logger.info("Testing PaginatedResponse.create method...")
...
logger.info(f"  ✅ Created response with {len(items)} items, total {total}, page {page}, size {size}")
logger.info(f"  ✅ Calculated {response.pages} pages correctly")
...
logger.info(f"  ✅ Total {total}, Size {size} -> {response.pages} pages")
    
logger.info("  ✅ PaginatedResponse.create method tests passed")

def main():
    """Run all tests."""
logger.info("🧪 Running Shared Schemas Tests")
logger.info("=" * 50)
...
logger.info()
logger.info("🎉 All tests passed! Coverage for lines 86, 101-102 achieved.")
logger.info()
logger.info("Summary:")
logger.info("- Line 86: PaginationParams.offset property ✅")
logger.info("- Lines 101-102: PaginatedResponse.create method ✅")
logger.info()
logger.info("✨ Shared Schemas module: 100% coverage achieved!")
