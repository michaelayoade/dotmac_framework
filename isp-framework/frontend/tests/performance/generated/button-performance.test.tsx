...
/**
 * Performance test for Simple Button Component
...
describe('Performance: Simple Button Component', () => {
  it('should render within performance thresholds', () => {
    const props = {
      "children": "Click me"
};
    
    const result = renderPerformance(<Button {...props} />);
    const metrics = result.measurePerformance();
    
    // Render time validation
    const renderTimeThreshold = PERFORMANCE_THRESHOLDS.renderTime.fast;
    expect(metrics.renderTime).toBeLessThan(renderTimeThreshold);
    
    // DOM nodes validation  
    const domNodesThreshold = PERFORMANCE_THRESHOLDS.domNodes.small;
    ...
    // Performance report
    console.log(`📊 Performance Metrics for Simple Button Component:`);
