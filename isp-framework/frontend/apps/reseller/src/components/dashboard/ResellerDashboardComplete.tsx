...
import { Badge, Button, Card, Progress } from '@dotmac/styled-components/design-system/components';
import {
  Award,
  BarChart3,
  Building,
            ...
            >
              <div className='space-y-6'>
                <div>
                  ...
                  <Progress
                    value={mockResellerData.targets.monthly.achieved}
                    max={mockResellerData.targets.monthly.target}
                    variant={
                      mockResellerData.targets.monthly.achieved >=
                      mockResellerData.targets.monthly.target
                        ? 'success'
                ...
                <div>
                  ...
                  <Progress
                    value={mockResellerData.targets.revenue.achieved}
                    max={mockResellerData.targets.revenue.target}
                    variant={
                      mockResellerData.targets.revenue.achieved >=
                      mockResellerData.targets.revenue.target
                        ? 'success'
                        : 'default'
                    }
                  />
