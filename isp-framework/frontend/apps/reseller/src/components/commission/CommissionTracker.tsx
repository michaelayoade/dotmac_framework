...
const mockCommissionData = {
  ...
  monthlyHistory: [
    ...
    { month: 'Apr 23', revenue: 41800, commission: 4180, customers: 23, tier: 'Gold', rate: 10.5 },
    { month: 'May 23', revenue: 45600, commission: 4788, customers: 26, tier: 'Gold', rate: 10.5 },
    { month: 'Jun 23', revenue: 52300, commission: 5492, customers: 29, tier: 'Gold', rate: 10.5 },
    { month: 'Jul 23', revenue: 58900, commission: 6184, customers: 32, tier: 'Gold', rate: 10.5 },
    {
      month: 'Aug 23',
      revenue: 62400,
      commission: 6552,
  ...
  tierProgress: {
    ...
    benefits: {
      current: ['11% commission rate', 'Priority support', 'Quarterly bonuses', 'Marketing co-op'],
      next: [
  ...
  commissionBreakdown: [
    { service: 'Fiber 1GB', count: 18, revenue: 23400, commission: 2574, rate: 11.0 },
    { service: 'Fiber 500MB', count: 15, revenue: 18750, commission: 2063, rate: 11.0 },
    { service: 'Business 100MB', count: 12, revenue: 15600, commission: 1716, rate: 11.0 },
    { service: 'Basic 50MB', count: 2, revenue: 1200, commission: 132, rate: 11.0 },
  ],
  forecasting: {
    nextMonth: {
...
export function CommissionTracker() {
  ...
  const [viewType, setViewType] = useState<'overview' | 'breakdown' | 'forecast' | 'incentives'>(
    'overview'
  );
  ...
  return (
    <div className='space-y-6'>
        ...
        >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            ...
            <Card className='p-6 bg-gradient-to-br from-purple-50 to-indigo-50 border-purple-200'>
              <div className='flex items-center justify-between'>
                <div>
                  <p className='text-purple-700 text-sm font-medium'>Tier Ranking</p>
                  <p className='text-3xl font-bold text-purple-800'>#{data.summary.rank}</p>
                  <div className='flex items-center mt-2'>
            ...
            <Card className='p-6 bg-gradient-to-br from-orange-50 to-red-50 border-orange-200'>
              <div className='flex items-center justify-between'>
                <div>
                  <p className='text-orange-700 text-sm font-medium'>Pending Payout</p>
          ...
          <Card className='p-6'>
            <div className='flex items-center justify-between mb-6'>
              <h3 className='text-lg font-semibold text-gray-900'>Commission Trends</h3>
              <div className='flex items-center space-x-2 text-sm text-gray-600'>
                <span>Avg Monthly:</span>
                <span className='font-semibold'>{formatCurrency(data.summary.averageMonthly)}</span>
              </div>
            </div>
            <div className='h-80'>
              <ResponsiveContainer width='100%' height='100%'>
                <ComposedChart data={filteredData}>
                  ...
                  />
                  <Bar yAxisId='right' dataKey='customers' fill='#F59E0B' opacity={0.7} />
                  <defs>
              ...
              <div className='space-y-4'>
                <div>
                  <div className='flex justify-between text-sm mb-2'>
                    ...
                    <span className='font-medium'>{data.tierProgress.progress}%</span>
                  </div>
                  ...
                  <div className='flex justify-between text-xs text-gray-600 mt-1'>
                    <span>{formatCurrency(data.tierProgress.currentThreshold)}</span>
                    <span>{formatCurrency(data.tierProgress.nextThreshold)}</span>
                  </div>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <div className='space-y-1'>
                      {data.tierProgress.benefits.current.map((benefit, index) => (
                  ...
                  <div>
                    <h4 className='font-medium text-gray-900 mb-2'>Next Tier Benefits</h4>
                    <div className='space-y-1'>
      ...
      {viewType === 'breakdown' && (
        ...
        >
          <Card className='p-6'>
            <h3 className='text-lg font-semibold text-gray-900 mb-6'>Commission by Service Type</h3>
      ...
      {viewType === 'forecast' && (
        ...
        >
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            ...
            <Card className='p-6 bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200'>
              <div className='text-center'>
                <div className='text-2xl font-bold text-blue-800 mb-2'>
                  {formatCurrency(data.forecasting.nextMonth.predictedCommission)}
                </div>
                <div className='text-blue-700 text-sm mb-4'>Next Month Forecast</div>
            ...
            <Card className='p-6 bg-gradient-to-br from-green-50 to-green-100 border-green-200'>
              <div className='text-center'>
                <div className='text-2xl font-bold text-green-800 mb-2'>
                  {formatCurrency(data.forecasting.nextQuarter.predictedCommission)}
                </div>
                <div className='text-green-700 text-sm mb-4'>Next Quarter Forecast</div>
                ...
                <div className='mt-4'>
                  <div className='text-xs text-green-700'>
                    Seasonal Adjustment: +
                    {formatPercent((data.forecasting.nextQuarter.seasonalAdjustment - 1) * 100)}
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card className='p-6 bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200'>
              <div className='text-center'>
                ...
                <div className='text-purple-700 text-sm mb-4'>Year-end Projection</div>
                ...
                <div className='w-full bg-purple-200 rounded-full h-2 mb-2'>
                  <div
                    ...
                    style={{ width: `${data.forecasting.yearEnd.probabilityOfTarget}%` }}
                  />
                </div>
                <div className='text-xs text-purple-700'>
                  {data.forecasting.yearEnd.probabilityOfTarget}% chance of hitting target
                </div>
              </div>
            </Card>
          </div>
          ...
          {/* Forecast Chart */}
          <Card className='p-6'>
            <h3 className='text-lg font-semibold text-gray-900 mb-6'>Commission Forecast</h3>
            <div className='h-80'>
              <ResponsiveContainer width='100%' height='100%'>
                <LineChart
                  data={[
                    ...
                    {
                      month: 'Feb 24',
                      commission: data.forecasting.nextMonth.predictedCommission,
                      forecast: true,
                    },
                    {
                      month: 'Mar 24',
                      commission: data.forecasting.nextMonth.predictedCommission * 1.05,
                      forecast: true,
                    },
                    {
                      month: 'Apr 24',
                      commission: data.forecasting.nextMonth.predictedCommission * 1.08,
                      forecast: true,
                    },
                  ]}
                >
      ...
      {viewType === 'incentives' && (
        ...
        >
          <Card className='p-6'>
            <div className='flex items-center justify-between mb-6'>
              <h3 className='text-lg font-semibold text-gray-900'>Active Incentives</h3>
              <div className='text-sm text-gray-600'>
                Total Potential:{' '}
                {formatCurrency(data.incentives.reduce((sum, inc) => sum + inc.reward, 0))}
              </div>
            </div>
                ...
                >
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='w-full bg-gray-200 rounded-full h-3'>
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${Math.min(incentive.progress, 100)}%` }}
