...
class AuthenticationProxyService:
    ...
    async def authenticate_request(
        self, headers: Dict[str, str], query_params: Dict[str, str], policy_id: str
    ) -> Dict[str, Any]:
    ...
    async def _authenticate_jwt(
        self, headers: Dict[str, str], policy: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            payload = await self.validate_jwt_token(
                token, policy["jwt_secret_key"], policy["jwt_algorithm"]
            )
...
class AuthenticationProxySDK:
    ...
    async def create_auth_policy(
        self, name: str, auth_type: str, required_scopes: List[str] = None, **kwargs
    ) -> Dict[str, Any]:
        """Create authentication policy."""
    ...
    async def create_jwt_auth_provider(
        self, name: str, secret_key: str, algorithm: str = "HS256", **kwargs
    ) -> Dict[str, Any]:
        """Create JWT authentication provider."""
        return await self._service.create_jwt_auth_provider(
            name=name, secret_key=secret_key, algorithm=algorithm, **kwargs
        )
    ...
    async def create_api_key_auth_provider(
        self, name: str, header_name: str = "X-API-Key", **kwargs
    ) -> Dict[str, Any]:
        """Create API key authentication provider."""
        return await self._service.create_api_key_auth_provider(
            name=name, header_name=header_name, **kwargs
        )

    async def generate_api_key(
        self, name: str, user_id: str = None, scopes: List[str] = None, **kwargs
    ) -> Dict[str, Any]:
        """Generate API key."""
    ...
    async def generate_jwt_token(
        self, user_id: str, scopes: List[str] = None, roles: List[str] = None, **kwargs
    ) -> Dict[str, Any]:
        """Generate JWT token."""
    ...
    async def authenticate_request(
        ...
        """Authenticate request based on policy."""
        return await self._service.authenticate_request(
            headers, query_params, policy_id
        )
