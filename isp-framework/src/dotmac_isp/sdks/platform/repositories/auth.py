...
from dotmac_isp.modules.identity.repository import UserRepository as IdentityUserRepository
from dotmac_isp.modules.identity.models import User
from dotmac_isp.sdks.core.exceptions import SDKError, NotFoundError
...
class UserRepository:
    ...
    async def find_by_id(self, user_id: UUID) -> Optional[User]:
        ...
        try:
            ...
            raise SDKError(f"Failed to find user by ID: {str(e)}")
    ...
    async def find_by_username(self, username: str) -> Optional[User]:
        ...
        try:
            ...
            raise SDKError(f"Failed to find user by username: {str(e)}")
    ...
    async def find_by_email(self, email: str) -> Optional[User]:
        ...
        try:
            ...
            raise SDKError(f"Failed to find user by email: {str(e)}")
    ...
    async def create(self, user_data: Dict[str, Any]) -> User:
        ...
        try:
            ...
            raise SDKError(f"Failed to create user: {str(e)}")
    ...
    async def update(self, user_id: UUID, user_data: Dict[str, Any]) -> Optional[User]:
        ...
        try:
            ...
            raise SDKError(f"Failed to update user: {str(e)}")
    ...
    async def delete(self, user_id: UUID) -> bool:
        ...
        try:
            ...
            raise SDKError(f"Failed to delete user: {str(e)}")
...
class UserSessionRepository:
    ...
    async def create_session(self, user_id: UUID, session_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            raise SDKError(f"Failed to create session: {str(e)}")
    ...
    async def update_session(self, session_id: str, session_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise SDKError(f"Failed to update session: {str(e)}")
    ...
    async def delete_session(self, session_id: str) -> bool:
        ...
        try:
            ...
            raise SDKError(f"Failed to delete session: {str(e)}")
    ...
    async def find_sessions_by_user(self, user_id: UUID) -> list[Dict[str, Any]]:
        ...
        try:
            ...
            raise SDKError(f"Failed to find user sessions: {str(e)}")