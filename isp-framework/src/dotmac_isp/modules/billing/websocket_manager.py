...
class WebSocketConnectionManager:
    ...
    async def _send_with_retry(self, websocket: websockets.WebSocketServerProtocol, 
    ...
    async def _send_to_websocket(self, websocket: websockets.WebSocketServerProtocol, 
    ...
    async def subscribe_to_redis_events(self, tenant_id: str, 
                                      callback: Callable[[BillingEvent], None]):
...
class BillingEventPublisher:
    ...
    async def publish_invoice_paid(self, tenant_id: str, customer_id: str, 
                                 invoice_id: str, payment_data: Dict[str, Any],
                                 user_id: Optional[str] = None):
    ...
    async def publish_payment_failed(self, tenant_id: str, customer_id: str, 
                                   payment_id: str, failure_data: Dict[str, Any],
                                   user_id: Optional[str] = None):
    ...
    async def publish_subscription_cancelled(self, tenant_id: str, customer_id: str, 
                                           subscription_id: str, cancellation_data: Dict[str, Any],
                                           user_id: Optional[str] = None):
