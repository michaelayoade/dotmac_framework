...
class BillingCalculationService(IBillingCalculationService):
    ...
    def calculate_tax(self, subtotal: Decimal, tax_rate: Decimal) -> Decimal:
        ...
        try:
            ...
            raise ValidationError(f"Invalid tax calculation: {str(e)}")
    ...
    def calculate_discount(self, subtotal: Decimal, discount_rate: Decimal) -> Decimal:
        ...
        try:
            ...
            logger.error(f"Discount calculation error: {str(e)}")
            raise ValidationError(f"Invalid discount calculation: {str(e)}")
    ...
    def calculate_line_item_total(
        ...
        try:
            ...
            logger.error(f"Line item calculation error: {str(e)}")
            raise ValidationError(f"Invalid line item calculation: {str(e)}")
    ...
    def calculate_invoice_total(
        ...
        try:
            ...
            if total < Decimal("0.00"):
                logger.warning(
                    f"Calculated total is negative: {total}, setting to 0.00"
                )
                total = Decimal("0.00")
            ...
            logger.error(f"Invoice total calculation error: {str(e)}")
            raise ValidationError(f"Invalid invoice total calculation: {str(e)}")
    ...
    def calculate_proration(
        ...
        try:
            ...
            logger.error(f"Proration calculation error: {str(e)}")
            raise ValidationError(f"Invalid proration calculation: {str(e)}")
    ...
    def calculate_late_fee(
        ...
        try:
            ...
            raise ValidationError(f"Invalid late fee calculation: {str(e)}")
    ...
    def calculate_compound_tax(
        ...
        try:
            ...
            logger.error(f"Compound tax calculation error: {str(e)}")
            raise ValidationError(f"Invalid compound tax calculation: {str(e)}")
    ...
    def calculate_payment_schedule(
        ...
        try:
            ...
            logger.error(f"Payment schedule calculation error: {str(e)}")
            raise ValidationError(f"Invalid payment schedule calculation: {str(e)}")
