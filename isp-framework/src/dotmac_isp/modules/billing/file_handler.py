...
class FileValidator:
    ...
    def validate_csv_structure(self, df: pd.DataFrame, expected_columns: List[str]) -> Dict[str, Any]:
...
class FileStorageManager:
    ...
    def _generate_filename(self, original_filename: str, tenant_id: str, 
    ...
    async def store_file(self, file: UploadFile, purpose: str, 
                        tenant_id: str, entity_id: Optional[str] = None) -> Dict[str, Any]:
        """Store uploaded file."""
...
class BulkImportProcessor:
    ...
    async def process_invoice_import(self, file_path: str) -> Dict[str, Any]:
        ...
        expected_columns = [
            'customer_id', 'invoice_date', 'due_date', 'description',
...
class FileUploadService:
    ...
    async def upload_invoice_attachment(self, file: UploadFile, tenant_id: str, 
    ...
    async def upload_payment_receipt(self, file: UploadFile, tenant_id: str, 
    ...
    async def upload_bulk_import(self, file: UploadFile, tenant_id: str, 
        ...
        if import_type == "invoices":
            ...
            processing_result = {'valid': False, 'error': f"Unknown import type: {import_type}"}
...
async def upload_invoice_attachment(file: UploadFile, tenant_id: str, 
                                  invoice_id: str) -> Dict[str, Any]:
    """Convenience function to upload invoice attachment."""
    return await file_upload_service.upload_invoice_attachment(file, tenant_id, invoice_id)


async def upload_payment_receipt(file: UploadFile, tenant_id: str, 
                               payment_id: str) -> Dict[str, Any]:
...
async def process_bulk_import(file: UploadFile, tenant_id: str, 
                            import_type: str) -> Dict[str, Any]:
