...
def _register_module_routers(app: FastAPI) -> None:
    ...
    module_routers = [
        ...
        ("dotmac_isp.modules.support.router", "support_router", "/api/v1/support"),
        (
        ...
        ("dotmac_isp.modules.sales.router", "sales_router", "/api/v1/sales"),
        ("dotmac_isp.modules.inventory.router", "router", "/api/v1/inventory"),
        ("dotmac_isp.modules.compliance.router", "router", "/api/v1/compliance"),
        ("dotmac_isp.modules.field_ops.router", "router", "/api/v1/field-ops"),
        ("dotmac_isp.modules.licensing.router", "router", "/api/v1/licensing"),
        ("dotmac_isp.modules.notifications.router", "router", "/api/v1/notifications"),
        (
        ...
        ("dotmac_isp.modules.resellers.router", "router", "/api/v1/resellers"),
    ]
