...
class PhoneVerificationService:
    ...
    async def get_verification(self, verification_id: UUID) -> Optional[PhoneVerification]:
...
class PhoneSDK:
    ...
    async def verify_phone_code(self, verification_id: str, code: str) -> Dict[str, Any]:
    ...
    async def get_verification_status(self, verification_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "sms_sent_at": verification.sms_sent_at.isoformat() if verification.sms_sent_at else None,
            "sms_delivered_at": verification.sms_delivered_at.isoformat() if verification.sms_delivered_at else None,
            "sms_failed_at": verification.sms_failed_at.isoformat() if verification.sms_failed_at else None,
