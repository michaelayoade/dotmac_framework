...
class EmailVerificationService:
    ...
    async def get_verification(self, verification_id: UUID) -> Optional[EmailVerification]:
...
class EmailSDK:
    ...
    async def send_verification_email(
        ...
        verification.delivery_attempted_at = verification.delivery_attempted_at.__class__.utcnow()
        verification.deliverability_status = DeliverabilityStatus.DELIVERED
        verification.delivery_confirmed_at = verification.delivery_confirmed_at.__class__.utcnow()
        ...
        return {
            ...
            "deliverability_status": verification.deliverability_status.value if verification.deliverability_status else None,
            "created_at": verification.created_at.isoformat(),
        }

    async def verify_email_code(self, verification_id: str, code: str) -> Dict[str, Any]:
    ...
    async def check_email_deliverability(self, email: str) -> Dict[str, Any]:
        ...
        deliverability_status = DeliverabilityStatus.DELIVERED if is_valid_format else DeliverabilityStatus.REJECTED
