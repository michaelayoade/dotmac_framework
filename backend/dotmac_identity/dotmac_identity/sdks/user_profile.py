...
class UserProfileService:
    ...
    async def create_profile(self, account_id: UUID, tenant_id: str, **kwargs) -> UserProfile:
        """Create user profile."""
        profile = UserProfile(
...
class UserProfileSDK:
    ...
    async def update_display_name(self, profile_id: str, display_name: str) -> Dict[str, Any]:
        """Update display name."""
    ...
    async def update_locale(self, profile_id: str, locale: str, timezone: str) -> Dict[str, Any]:
