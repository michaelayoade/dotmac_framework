...
class StepDefinition(BaseModel):
    ...
    # Parallel execution
    parallel_steps: List["StepDefinition"] = Field(default_factory=list, description="Parallel sub-steps")
...
class WorkflowDefinition(BaseModel):
    ...
    # Policies
    default_retry_policy: Optional[RetryPolicy] = Field(None, description="Default retry policy")
    default_timeout_policy: Optional[TimeoutPolicy] = Field(None, description="Default timeout policy")
...
class WorkflowEngine:
    ...
    def _map_data(self, mapping: Dict[str, str], source_data: Dict[str, Any]) -> Dict[str, Any]:
