...
class VLANService:
    ...
    async def create_vlan(self, **kwargs) -> Dict[str, Any]:
        ...
        vlan = {
            ...
            "vlan_type": kwargs.get("vlan_type", "customer"),  # customer, management, trunk
    ...
    async def auto_assign_vlan(self, **kwargs) -> Dict[str, Any]:
        ...
        raise VLANError(f"No available VLANs in range {vlan_range_start}-{vlan_range_end}")
...
class VLANSDK:
    ...
    async def get_port_vlans(self, port_id: str) -> List[Dict[str, Any]]:
        ...
        assignments = [
            assign for assign in self._service._assignments.values()
