...
class DeviceConfigSDK(NetJSONConfigMixin):
    ...
    async def detect_config_drift(self, device_id: str, running_config: str) -> Dict[str, Any]:
        ...
        if drift_result["drift_detected"]:
            ...
            raise ConfigDriftDetectedError(device_id, {
    ...
    async def approve_config_intent(self, intent_id: str, approver: str, comments: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def get_pending_approvals(self) -> List[Dict[str, Any]]:
        ...
        pending_intents = [
            intent for intent in self._service._intents.values()
