...
class RADIUSServerMgmtService:
    ...
    async def add_client(self, **kwargs) -> Dict[str, Any]:
        ...
        client = {
            ...
            "require_message_authenticator": kwargs.get("require_message_authenticator", True),
    ...
    def _generate_clients_config(self) -> str:
        ...
        config_lines = ["# RADIUS Clients Configuration", "# Generated automatically", ""]
    ...
    def _generate_policies_config(self) -> str:
        ...
        config_lines = ["# RADIUS Policies Configuration", "# Generated automatically", ""]
        ...
        for dictionary in self._dictionaries.values():
            if dictionary["status"] == "active":
                ...
                if dictionary["vendor_id"]:
                    config_lines.append(f"VENDOR {dictionary['dict_name']} {dictionary['vendor_id']}")

                for attr in dictionary["attributes"]:
                    config_lines.append(f"ATTRIBUTE {attr['name']} {attr['id']} {attr['type']}")

                for value in dictionary["values"]:
                    config_lines.append(f"VALUE {value['attribute']} {value['name']} {value['value']}")
...
class RADIUSServerMgmtSDK:
    ...
    async def list_policies(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            for policy in sorted(self._service._policies.values(), key=lambda p: p["priority"])
        ]

    async def update_client_secret(self, client_id: str, new_secret: str) -> Dict[str, Any]:
