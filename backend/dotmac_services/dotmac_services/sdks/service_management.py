...
class ServiceManagementService:
    ...
    def __init__(self):
        ...
        self._valid_transitions = {
            ServiceState.REQUESTED: [ServiceState.PROVISIONING, ServiceState.FAILED, ServiceState.TERMINATED],
            ServiceState.PROVISIONING: [ServiceState.ACTIVE, ServiceState.FAILED, ServiceState.TERMINATED],
    ...
    async def _start_provisioning(self, instance_id: str, **kwargs):
        ...
        provisioning_task = {
            ...
            "steps": kwargs.get("provisioning_steps", [
                "validate_resources",
                "allocate_resources",
                "configure_service",
                "test_connectivity",
    ...
    async def _suspend_service(self, instance_id: str, **kwargs):
        ...
        instance["suspension_reason"] = kwargs.get("suspension_reason", "Administrative action")
        instance["suspension_type"] = kwargs.get("suspension_type", "manual")  # manual, automatic, billing
    ...
    async def _terminate_service(self, instance_id: str, **kwargs):
        ...
        instance["termination_reason"] = kwargs.get("termination_reason", "Customer request")
        instance["termination_type"] = kwargs.get("termination_type", "normal")  # normal, forced, billing
    ...
    async def update_provisioning_progress(
        ...
        if progress_percentage >= 100 and instance["state"] == ServiceState.PROVISIONING.value:
