...
class RedisAdapter(EventAdapter):
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            logger.info("Connected to Redis", host=self.config.host, port=self.config.port)
                    ...
                    for stream_key, stream_messages in messages:
                        ...
                        for message_id, fields in stream_messages:
                            try:
                                ...
                                if auto_commit:
                                    await self._client.xack(stream_key, group_key, message_id)
    ...
    async def seek_to_beginning(
        ...
        logger.warning("Redis streams don't support seeking, consider recreating consumer group")
