...
class APIVersioningService:
    ...
    async def create_versioned_route(self, **kwargs) -> Dict[str, Any]:
        ...
        mapping = {
            ...
            "versioning_strategy": kwargs.get("versioning_strategy", "path"),  # path, header, content_negotiation
    ...
    async def configure_content_negotiation_versioning(self, **kwargs) -> Dict[str, Any]:
        """Configure content negotiation versioning."""
        config = {
            "api_name": kwargs["api_name"],
            "media_types": kwargs["media_types"],  # {"application/vnd.api.v1+json": "v1"}
