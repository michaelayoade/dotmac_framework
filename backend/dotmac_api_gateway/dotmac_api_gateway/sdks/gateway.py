...
class GatewayService:
    ...
    async def create_gateway(self, **kwargs) -> Dict[str, Any]:
        ...
        gateway = {
            ...
            "load_balancer_algorithm": kwargs.get("load_balancer_algorithm", "round_robin"),
    ...
    async def configure_load_balancer(self, gateway_id: str, **config) -> Dict[str, Any]:
        ...
        lb_config = {
            ...
            "max_connections_per_upstream": config.get("max_connections_per_upstream", 100),
    ...
    async def register_upstream_service(self, **kwargs) -> Dict[str, Any]:
        ...
        service = {
            ...
            "name": kwargs["name"],
            "url": kwargs["url"],
            "health_check_url": kwargs.get("health_check_url", f"{kwargs['url']}/health"),
...
class GatewaySDK:
    ...
    async def apply_rate_limit_policy(self, route_id: str, rate_limit_policy_id: str) -> bool:
        """Apply rate limiting policy to route."""
        await self._service.update_route(route_id, rate_limit_policy_id=rate_limit_policy_id)
        return True
