...
class APIDocumentationService:
    ...
    async def create_api_explorer(self, **kwargs) -> Dict[str, Any]:
        ...
        explorer = {
            ...
            "enable_request_persistence": kwargs.get("enable_request_persistence", True),
        ...
        return {
            "Customer": {
                ...
                "properties": {
                    ...
                    "customer_type": {"type": "string", "enum": ["residential", "business"], "example": "business"},
            ...
            "CustomerInput": {
                ...
                "properties": {
                    "display_name": {"type": "string", "example": "Acme Corp"},
                    "customer_type": {"type": "string", "enum": ["residential", "business"], "example": "business"},
                    "contact_email": {"type": "string", "format": "email", "example": "contact@acme.com"},
            ...
            "Error": {
                ...
                "properties": {
                    ...
                    "details": {"type": "object", "example": {"field": "email", "issue": "Invalid format"}}
                },
...
class APIDocumentationSDK:
    ...
    async def create_api_explorer(
        self,
        portal_id: str,
        **kwargs
    ) -> Dict[str, Any]:
        """Create interactive API explorer."""
        return await self._service.create_api_explorer(
            portal_id=portal_id,
            **kwargs
        )
