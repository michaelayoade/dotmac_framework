    ...
    def __init__(self, **data):
        ...
        if self.openbao_enabled:
            try:
                ...
                logger.warning(f"Failed to load from OpenBao: {e}. Using environment variables.")
        ...
        try:
            ...
            if not os.getenv("DATABASE_URL"):
                try:
                    ...
                    logger.info(f"Using dynamic database credentials (TTL: {db_creds['ttl']}s)")
                except Exception as e:
...
if __name__ == "__main__":
    ...
    config = get_service_config(
        ...
        use_openbao=not args.no_openbao
    )
