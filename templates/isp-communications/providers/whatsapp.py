...
class WhatsAppProvider:
    ...
    async def _send_ultramsg(self, to: str, template: Optional[str] = None, vars: Optional[dict[str, Any]] = None, body: Optional[str] = None) -> str:
    ...
    async def _send_infobip(self, to: str, template: Optional[str] = None, vars: Optional[dict[str, Any]] = None, body: Optional[str] = None) -> str:
        ...
        payload = {"from": os.getenv("INFOBIP_SENDER", "DotMac"), "to": to, "content": {"text": message_body}}

        headers = {"Authorization": f"App {os.getenv('INFOBIP_API_KEY')}", "Content-Type": "application/json"}
