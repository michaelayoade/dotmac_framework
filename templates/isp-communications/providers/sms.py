...
class SMSProvider:
    ...
    async def _send_twilio(self, to: str, template: str = None, vars: Dict[str, Any] = {}, body: str = None) -> str:
        """Send via Twilio API"""
    ...
    async def _send_vonage(self, to: str, template: str = None, vars: Dict[str, Any] = {}, body: str = None) -> str:
