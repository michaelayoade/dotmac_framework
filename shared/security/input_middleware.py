...
class InputSanitizationMiddleware:
    ...
    def __init__(
        ...
        self.exempt_paths = exempt_paths or ['/docs', '/redoc', '/openapi.json', '/health', '/metrics']
        ...
        if scope["type"] == "http":
            ...
            async def receive_wrapper():
                ...
                if message["type"] == "http.request" and not body_sanitized:
                    ...
                    elif request.headers.get('content-type', '').startswith(('application/x-www-form-urlencoded', 'multipart/form-data')):
