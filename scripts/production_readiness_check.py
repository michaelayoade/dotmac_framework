...
class ProductionReadinessChecker:
    ...
    async def check_package_constraints(self) -> bool:
        ...
        try:
            ...
            dotmac_packages = [
                "dotmac-application", "dotmac-observability", "dotmac-tenant",
                "dotmac-auth", "dotmac-tasks", "dotmac-database", 
                "dotmac-events", "dotmac-secrets", "dotmac-websockets",
                "dotmac-plugins"
            ]
